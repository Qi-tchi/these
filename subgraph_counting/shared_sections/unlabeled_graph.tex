...
\begin{example}
    In an unlabeled graph, edges are directed and will be visualized as arrows; between any two nodes, there can be multiple edges, and loops are allowed. The following is an example of an unlabeled graph:
     \begin{center}
        \begin{tikzpicture}
