...
\begin{definition}
    ...
    An \textbf{unlabeled multigraph} \( G \) is a labeled graph such that the labeling function is constant, i.e., there is a label \( l \mathop{\in} \Sigma \) such that \( \lambda_G(e) \mathop{=} l \) for all edges \( e \) in $G$.
\end{definition}
