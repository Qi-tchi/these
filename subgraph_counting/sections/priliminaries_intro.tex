...
In this chapter, we focus on DPO rewriting with injective rules and matches. While our definitions of injective rewriting rules and steps may initially appear more restrictive, they are equivalent to those introduced in \autoref{sec:dpo}. This equivalence arises because algebraic graph rewriting via double pushouts is defined up to isomorphism. Our preference for these definitions stems from their practical advantage: they provide a clearer view of how the number of isomorphisms from specific subgraphs changes before and after a rewriting step.
