...
% % Let $t_X$, $t_G, t_{H'}$ and $t_H$ be the unique graph homomorphisms from $X$, $G, H'$ and $H$ to $T_\Sigma^X$, defined in \autoref{def:t_sigm_x}.
% Let \(t_X\), \(t_G\), \(t_{H'}\), and \(t_H\) be the unique graph homomorphisms from \(X\), \(G\), \(H'\), and \(H\) to \(T_\Sigma^X\), as defined in \autoref{def:t_sigm_x}. We define 
...
%    By \autoref{def:weight_excluding},
    % \begin{flalign*}
