...
% \begin{proof}
%     Suppose, by contradiction, that there exist \(b \mathop{\in} B \mathop{\setminus} \operatorname{Im}(\alpha)\) and \(c \mathop{\in} C\) such that \(\beta'(b) \mathop{=} \alpha'(c)\). By~\autoref{lem:b_c_same_img_exist_a}, there exists \(a \mathop{\in} A\) such that \(\alpha(a) \mathop{=} b\). This contradicts the assumption that \(b \notin \operatorname{Im}(\alpha)\) since \(\alpha(a) \mathop{=} b\) implies \(b \mathop{\in} \operatorname{Im}(\alpha)\).  
% \end{proof}
...
% \end{lemma}
% \begin{proof}
%     we have $ h_{K'C'} \mathop{\star} h_{C'C} \mathop{\star} h_{CH'} \mathop{=} h_{K'R'} \mathop{\star} h_{R'R_X} \mathop{\star} h_{R_XH'} $ by~\autoref{lem:dpo_dpo_unique_homo}. By the universal mapping property of the pushout $\square K'C'XR'$, we conclude.
%     \qed
% \end{proof}
...
\begin{flalign*}
    ...
    =& h_{K'C'} \mathop{\star}  h_{C'C}  \mathop{\star} h_{CH'} & \text{by \eqref{eq:h_cpk_star_h_kc_eq_h_cpc}} \\
...
Thus, the commutative diagram depicted below holds:
    ...
    \begin{flalign*}
        ...
        \mathop{=}  & (h_{C'K} \mathop{\star} h_{KR_X}) \mathop{\star} h_{R_XH'}  & \text{by \eqref{hcpx_star_hxrx}}\\
        ...
        \mathop{=}  & h_{C'C} \mathop{\star}  h_{CH'}  & \text{by \eqref{eq:h_cpk_star_h_kc_eq_h_cpc}}\\
    \end{flalign*}
    and 
    \begin{flalign*}
        & h_{R'X} \mathop{\star} (h_{XR_X} \mathop{\star}  h_{R_XH'})    \\
        \mathop{=} &  (h_{R'X} \mathop{\star} h_{XR_X}) \mathop{\star}  h_{R_XH'} & \text{by associativity}  \\
        =&  h_{R'R_X} \mathop{\star}  h_{R_XH'}  & \text{by \eqref{hrpx_star_hxrx}}  \\
    \end{flalign*}
...
\end{center}
    ...
    \begin{flalign*}
        ...
        &= (h_{R'X} \mathop{\star} (h_{XC} \mathop{\star} h_{CG}))(r') & \text{by \eqref{hyp:xhpgc}} \\
    ...
    \end{center}
        ...
        \begin{flalign*}
            ...
            =& (h_{C'X} \mathop{\star} (h_{XL} \mathop{\star} h_{LG}))(c') & \text{by \eqref{hyp:xhpgl}} \\
...
\begin{proof}
    ...
    We have $h_{XH'} \mathop{\star} h_{H'G} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$ by~\autoref{lem:hxhp_star_hhpg_in_psi_u_lnotl_lnotc}\todo{ici, we do not need c' and r' be arrows}.
...
\begin{proof}
    ...
    \begin{center}
        ...
        \begin{flalign*}
            ...
            &= (h_{R'X} \mathop{\star} h_{XH'}) \mathop{\star} h_{H'H} &\text{by \eqref{eq:rpxhprx}}\\
...
\begin{itemize}
    ...
    \begin{flalign*}
        ...
        &= h_{XH'} \mathop{\star} h_{H'H} & \text{by \eqref{hyp:xchp}} \\
...
\begin{itemize}
    ...
    \begin{flalign*}
        h_{XR} \mathop{\star} h_{RH} &= (h_{XR_X} \mathop{\star} h_{R_XR}) \mathop{\star} h_{RH} & \text{by definition of $h_{XR}$} \\
                            ...
                            &= h_{XH'} \mathop{\star} h_{H'H} & \text{by \eqref{hyp:xrxhp}} \\
                            &= h_{XH} & \text{by commutativity of $\triangle XHH'$}
    \end{flalign*}
...
\begin{proof}
    ...
    We conclude that $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$ by~\autoref{lem:ifin_psi_lnot_r_lnot_c_thenin_psi_lnot_rx_lnot_c}.
