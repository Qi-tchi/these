...
\begin{definition} 
    ...
    For a ruler-graph \( X \) and a graph \( G \), the \textbf{measurement}\index{Measurement} \( m_X(G) \) is defined as the number of $X$-occurrences in $G$, i.e. the cardinality of the set of monomorphisms from $ X $ to $ G $:
    \(
...
\begin{definition} 
    ...
    A \textbf{weight function}\index{Weight function} for a set of ruler-graphs \( \mathbb{X} \) is a map \( s_{\mathbb{X}} \mathop{\colon} \mathbb{X} \mathop{\to} \mathbb{N} \) assigning a weight in $\mathbb{N}$ to each ruler-graph. The weight of a monomorphism from a ruler-graph $X$ is defined to be $s_\mathbb{X}(X)$. 
\end{definition}
...
\end{center}
 ...
 \index{$\operatorname{Mono}(X,G,\alpha)$}
 \index{$\operatorname{Mono}(X,G,\lnot \alpha)$}
 \index{$\operatorname{Mono}(X,G,\lnot \alpha, \beta)$}
 \index{$\operatorname{Mono}(X,G,\lnot \alpha, \lnot \beta)$}  
    \begin{align*}
