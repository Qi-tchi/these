...
\begin{proof}
    ...
    \begin{flalign*}
        ...
        &= h_{AR'} \mathop{\star} h_{R'R} &\text{by~\eqref{hakpkprparp}} \\
        &= h_{AK} \mathop{\star} h_{KR}. &\text{by~\eqref{harprprakkr}}
    \end{flalign*}
        ...
        We have three cases:
            \begin{itemize}
                \item[(3.1)] Suppose that $h_{C'C}(c') \notin \operatorname{Im}(h_{KC})$. We have
                    \begin{flalign*}
                        &h_{XG}(x_1) \\
                       =& h_{XG}(h_{C'X}(c')) & \text{by definition of $c'$}\\
...
\begin{proof}
    ...
    From $h_{XH}' \mathop{\neq} h_{XH}''$, we deduce there is an element $x \mathop{\in} X$ such that the inequality $h_{XH}(x) \mathop{\neq} h_{XH}''(x)$ holds. We can suppose that 
        ...
        \end{flalign} 
         \todo{$x$ is either an isolated node or an edge}
    ...
    \begin{itemize}
        ...
        There is $k'' \mathop{\in} K''$ such that $h_{K''K}(k'') \mathop{=} k_2$ and $h_{K''C''}(k'') \mathop{=} c''$ becase the square $K''C''CK$ is a pullback and $h_{KC}(k_2) \mathop{=} h_{C''C}(c'')$.
