...
\begin{center}
    ...
    \begin{tikzpicture}[baseline=-7mm]
        ...
        \graphbox{$K_\rho$}{27mm}{0mm}{23mm}{12mm}{2mm}{-5mm}{
          \node[draw,circle] (x) at (0mm,0mm) {$1$};
        }
        \begin{scope}[opacity=1]        
        \graphbox{$R_\rho$}{56mm}{0mm}{30mm}{12mm}{-1mm}{-5mm}{
          \node[draw,circle] (x) at (0mm,0mm) {$1$};
  ...
  \begin{center}
      $\tau\mathop{=}${
      \begin{tikzpicture}[baseline=-18mm,scale=0.9]
          \graphbox{$L_\tau$}{0mm}{-11mm}{32mm}{12mm}{2mm}{-7mm}{
          \node[draw,circle]  (x) at (-6mm,0mm) {$1$};
          \node[draw,circle] (y) at (6mm,0mm) {$2$};
          \draw[->]  (x) to (y);
          }
          \graphbox{$K_\tau$}{36mm}{-11mm}{32mm}{12mm}{2.5mm}{-7mm}{
              \node[draw,circle]  (x) at (-6mm,0mm) {$1$};
              \node[draw,circle]  (y) at (6mm,0mm) {$2$};
          }
          \begin{scope}[opacity=1]        
          \graphbox{$R_\tau$}{72mm}{-11mm}{40mm}{12mm}{-2mm}{-7mm}{
              \node[draw,circle]  (x) at (-6mm,0mm) {$1$};
              \node[draw,circle]  (y) at (6mm,0mm) {$2$};
