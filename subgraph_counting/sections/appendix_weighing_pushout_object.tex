...
\begin{proof}
    ...
    Therefore, the following inequality holds
     \begin{flalign*}
       ...
       \geq& \card{\operatorname{Mono}(X, L, \lnot l)} - \card{\operatorname{Mono}(X, R, \lnot r)} \hspace{3cm} \text{by \autoref{lem:w_u_l_not_geq_r_not}} \\
...
\noindent
\begin*{\textbf{\autoref{thm:subgraph_counting:termination_grs}}}[Termination]
