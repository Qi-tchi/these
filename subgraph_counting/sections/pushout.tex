...
\end{example}
\begin{definition} 
    to do : un example avec un span qui n'a pas de pushout
\end{definition}
The \emph{pullback}, defined below, is the dual construction of the pushout in category theory, and it can be thought of as construction of the interface structure along which two structures are glued together. (to do: double check)
\begin{definition} 
    \label{def:cat:pb}
