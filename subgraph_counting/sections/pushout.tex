...
\todo{todo: c'est bien. Modifier les autres sections.}
\begin{definition}
    \label{def:cat}
...
\begin{example}
    ...
    %  in~\autoref{fig:preliminaries:category}. 
...
%  in~\autoref{fig:preliminaries:span_cospan}. 
...
\begin{example}
    ...
    %  in~\autoref{fig:preliminaries:commutative_diagram}. 
...
\begin{definition}
    ...
    %  in~\autoref{fig:preliminaries:pushout_sdfkjasdlgjfl}
...
\begin{example}
    ...
    %  in~\autoref{fig:preliminaries:pushout_injective} 
...
\begin{example}
    ...
    Consider the diagram in the category \textbf{Graph} shown below.
    % The diagram 
    % in~\autoref{fig:preliminaries:pushout_non_injective} is a pushout square in the category \textbf{Graph}. 
...
%    in~\autoref{fig:preliminaries:pullback_ssdsfd},
...
\begin{example} 
    ...
    % shown in~\autoref{fig:preliminaries:a_rewriting_step_dfjalsdkdfsdfjflg}. 
...
\begin{example}
    ...
    % \end{figure}
\end{example} 
An important phenomenon about pushouts and pullbacks in the category \textbf{Graph} is stated in the following proposition. For examples, consider the diagrams in~\autoref{ex:cat:pushout_non_injective_ssss} and~\autoref{ex:cat:pbfsdljkgjasssss}.
