...
\begin{tikzpicture}[baseline=-15mm,scale=1.2]
    \graphbox{$L$}{0mm}{0mm}{31mm}{18mm}{2mm}{-13mm}{
    ...
    \graphbox{$K$}{35mm}{-0mm}{18mm}{18mm}{0mm}{-10mm}{
    }
    \begin{scope}  
    \graphbox{$R$}{57mm}{-0mm}{38mm}{18mm}{2mm}{-13mm}{
    ...
    \end{scope}
    \node () at (33mm,-8mm) {$\leftarrowtail$};
    \node () at (55mm,-8mm) {$\rightarrowtail$};
\end{tikzpicture}
}