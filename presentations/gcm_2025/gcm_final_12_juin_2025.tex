  ...
  \begin{itemize}
      ...
      % : function from graph $K$ to graph $L$ that preserves the structure of the graphs.
        ...
        \end{tikzpicture}
         ...
         \end{center}
      \item Double pushout (DPO) graph rewriting
      %   \begin{center}
      ...
      \item Rules $\varphi \mathop{=} (L \overset{l}{\leftarrow} K \overset{r}{\rightarrow} R)$ consist of two graph morphisms $l: K \mathop{\to} L$ and $r: K \mathop{\to} R$.
      \item Rewriting steps $G \mathop{\Rightarrow}_\varphi H$ are double-pushouts:
         \begin{center}
...
%   % \begin{definition}
%   %   % Let $T \mathop{=} (T,\mathbb{E}, S, w)$ be a type graph, \(\rho \mathop{=} (L \overset{l}{\leftarrow} K \overset{r}{\rightarrow} R ) \) a DPO rewriting rule and $\mathfrak{F}$ a rewriting framework. 
...
%   % $w_T(G) \mathop{>} w_T(H)$ for every rewriting step $G \mathop{\Rightarrow}_\varphi H$ using rule $\varphi \mathop{=} L \overset{l}{\leftarrow} K \overset{r}{\rightarrow} R$ if
%   }
...
% %  $$ \sum ( w_T \{t_L :L \mathop{\to} T \mid \text{$t_L$ extends $t_K$}\} )
