...
% Style for the framesubtitle
\setbeamerfont{framesubtitle}{size=\small}
\setbeamercolor{framesubtitle}{fg=structure!60!black}

% Redefine frametitle template to include framesubtitle under the title
\makeatletter
\setbeamertemplate{frametitle}{
  \begin{beamercolorbox}[sep=0.3cm,wd=\paperwidth]{frametitle}
    \usebeamerfont{frametitle}\insertframetitle\par
    % print framesubtitle only if non-empty
    \if\relax\detokenize\expandafter{\insertframesubtitle}\relax
...
\begin{frame}{Graph Transformation}
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \draw[fill=PineGreen, PineGreen,-] (n1)--(n2);
            \draw[fill=PineGreen, PineGreen,-] (n2)--(n3)--(n4);
            \draw[fill=PineGreen, PineGreen,-] (n4)--(n1);
            \draw[fill=PineGreen, PineGreen,-] (n3)--(n6);
            \draw[fill=PineGreen, PineGreen,-] (n6)--(n5);
            \draw[fill=PineGreen, PineGreen,-] (n5)--(n3);
            \draw[red, dashed, very thick] (0,0) circle (1.65);
        \end{tikzpicture}
    \end{center}
    ...
    \begin{overlayarea}{\textwidth}{\textheight}
        ...
        \end{onlyenv}
          \begin{onlyenv}<12->
            ...
            \draw[red,-] (n1)-- node[pos=0.6, left] {} (n2);
            \draw[red,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[gray,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[red,-] (n3)-- node[pos=0.65,left] {}(n6);
            \draw[gray,-] (n6)-- node[pos=0.4,right] {}(n5);
            \draw[red,-] (n5)-- node[pos=0.4,left] {}(n3);
            }
        \end{tikzpicture}
        \end{onlyenv}
...
\begin{frame}{Termination by interpretations}
...
\begin{frame}{Limitation}
  ...
  \end{description}
\end{frame}
% rigorous robust catastrophe "require minimal 
...
\begin{frame}{Morphisms by Image Node Colors}
 ...
 \begin{center}
   ...
   $X$-morphisms are classified by the colors of their image nodes:
    \begin{itemize}
        \item \textcolor{orange}{orange}: only \textcolor{black}{white} and \textcolor{orange}{orange} nodes;
        \item \textcolor{red}{red}: only \textcolor{black}{white} and \textcolor{red}{red} nodes; 
        \item \textcolor{blue}{blue}: only \textcolor{black}{white} and \textcolor{blue}{blue} nodes;
        \item \textcolor{blue}{blue}-and-\textcolor{orange}{orange}: \textcolor{blue}{blue} and \textcolor{orange}{orange} nodes;
        \item \textcolor{blue}{blue}-and-\textcolor{red}{red}: \textcolor{blue}{blue} and \textcolor{red}{red} nodes.
    \end{itemize}
\end{frame}
...
\textcolor{blue}{Blue} $X$-morphisms:  \resizebox{0.18\textwidth}{!}{
        \tikz[baseline=-0.5ex]{ 
...
\textcolor{orange}{Orange} $X$-morphisms:
...
\textcolor{blue}{Blue}-and-\textcolor{orange}{Orange} $X$-morphisms:
     \resizebox{0.18\textwidth}{!}{
        \tikz[baseline=-0.5ex]{ 
...
\textcolor{red}{Red} $X$-morphisms: none.

\textcolor{blue}{Blue}-and-\textcolor{red}{red} $X$-morphisms:
    \resizebox{0.18\textwidth}{!}{
        \tikz[baseline=-0.5ex]{ 
...
\begin{frame}{A Sufficient Condition for Termination}
   ...
   \end{center}
            ...
            \begin{itemize}
                \item strictly more \textcolor{orange}{orange} X-morphisms than \textcolor{red}{red} X-morphisms, 
                \item more \textcolor{blue}{blue}-and-\textcolor{orange}{orange} X-morphisms than \textcolor{blue}{blue}-and-\textcolor{red}{red} X-morphisms.
            \end{itemize}

 \textcolor{red}{Challenge}: C' is unknown before rewriting.
\end{frame} 
...
\begin{frame}{A Sufficient Condition for the Second Condition}
    \begin{center}
        \begin{tikzpicture} 
            \coordinate (k) at (0, 0);
            \draw[fill=white] ($(k)+(0,0)$) rectangle ($(k)+(0.5,0.5)$);
