...
\begin{frame}{Termination of a Graph Transformation System}
  \begin{itemize}
...
\begin{frame}{A non-trivial case}
    \begin{center}
      \resizebox{\textwidth}{!}{
       \begin{tikzpicture}[baseline=-10mm]
...
\section{An Extension of the Weighted Type Graph Method}
\begin{frame}
...
\begin{frame}{Termination Criterion}
    ...
    \end{center}
      ...
      \begin{beamercolorbox}[wd=\textwidth,sep=1.2ex]{block body}
        Every rewriting step strictly decreases the weight if 
        \begin{itemize}
        \item for all \textcolor{blue}{$t_K$}, if there is \textcolor{PineGreen}{$t_L$} making $\triangle KLT$ commute, then 
        \begin{flalign*}
            &\min \{\opn{weight}_T(\textcolor{PineGreen}{t_L}) \mid \triangle KLT \text{commutes}\}  
            \\ \mathop{>}
            &\min \{\opn{weight}_T(\textcolor{red}{t_R}) \mid \triangle KRT \text{commutes}\}  
        \end{flalign*}
        \end{itemize} 
    \end{beamercolorbox}
...
\begin{frame}{Termination Criterion}
    ...
    \begin{tikzpicture}
            ...
            \draw [->,dashed] (r) to node [midway,right] {$t_R$} (t);
        \end{tikzpicture}
    \end{center}
      ...
      \begin{beamercolorbox}[wd=\textwidth,sep=1.2ex]{block body}
        Every rewriting step strictly decreases the weight if 
        \begin{itemize}
        \item there is \textcolor{red}{$\delta > 0$}, for all $t_K$, if there is $t_L$ making $\triangle KLT$ commute, then 
        \begin{flalign*}
            &\min \{\opn{weight}_T(t_L) \mid \triangle KLT \text{commutes}\}  
            \\ \mathop{>}
            &\min \{\opn{weight}_T(t_R) \mid \triangle KRT \text{commutes}\} \textcolor{red}{\mathop{+}\delta}
        \end{flalign*}
        \end{itemize} 
    \end{beamercolorbox}
...
\tikz[baseline=-0.5ex]{ 
  ...
  \begin{center}
    ...
    \end{center}
The morphisms from $X$ has their images as follows:
\begin{itemize}
    \item in $G$ and $L$:
