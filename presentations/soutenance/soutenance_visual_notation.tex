 ...
 Graph representing a configuration of a distributed system:
    \begin{overlayarea}{\textwidth}{\textheight}
        \begin{center}
            ...
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n1) at (0,0) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n2) at (1,1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n3) at (2,0) {};
            \node[red!30,fill=red!30,draw, circle] (n4) at (1,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n5) at (3,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n6) at (3,1) {};
            \draw[PineGreen!30,-] (n1)-- node[pos=0.6, left] {} (n2);
            \draw[PineGreen!30,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[PineGreen!30,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.65,left] {}(n6);
            \draw[PineGreen!30,-] (n6)-- node[pos=0.4,right] {}(n5);
            \draw[PineGreen!30,-] (n5)-- node[pos=0.4,left] {}(n3);
            }
        ...
        \end{onlyenv}
         \begin{onlyenv}<3>
               \begin{tikzpicture}
            \graphbox{}{0mm}{0mm}{45mm}{35mm}{-14mm}{-17mm}{
            \node[red!30,fill=red!30,draw, circle] (n1) at (0,0) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n2) at (1,1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n3) at (2,0) {};
            \node[red!30,fill=red!30,draw, circle] (n4) at (1,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n5) at (3,-1) {};
            ...
            \draw[PineGreen!30,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[red!30,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.65,left] {}(n6);
            \draw[PineGreen!30,-] (n6)-- node[pos=0.4,right] {}(n5);
            \draw[PineGreen!30,-] (n5)-- node[pos=0.4,left] {}(n3);
            }
        ...
        \begin{onlyenv}<5>
            ...
            \graphbox{}{0mm}{0mm}{45mm}{35mm}{-14mm}{-17mm}{
            \node[red!30,fill=red!30,draw, circle] (n1) at (0,0) {};
            \node[red!30,fill=red!30,draw, circle] (n2) at (1,1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n3) at (2,0) {};
            \node[red!30,fill=red!30,draw, circle] (n4) at (1,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n5) at (3,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n6) at (3,1) {};
            \draw[red!30,-] (n1)-- node[pos=0.6, left] {} (n2);
            \draw[PineGreen!30,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[red!30,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.65,left] {}(n6);
        ...
        \end{onlyenv}
         \begin{onlyenv}<7>
            ...
            \node[red!30,fill=red!30,draw, circle] (n1) at (0,0) {};
            \node[red!30,fill=red!30,draw, circle] (n2) at (1,1) {};
            \node[red!30,fill=red!30,draw, circle] (n3) at (2,0) {};
            \node[red!30,fill=red!30,draw, circle] (n4) at (1,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n5) at (3,-1) {};
            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (n6) at (3,1) {};
            \draw[red!30,-] (n1)-- node[pos=0.6, left] {} (n2);
            \draw[red!30,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[red!30,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.65,left] {}(n6);
            \draw[PineGreen!30,-] (n6)-- node[pos=0.4,right] {}(n5);
        ...
        \begin{onlyenv}<9->
            ...
            \node[red!30,fill=red!30,draw, circle] (n3) at (2,0) {};
            \node[red!30,fill=red!30,draw, circle] (n4) at (1,-1) {};
            \node[red!30,fill=red!30,draw, circle] (n5) at (3,-1) {};
            \node[red!30,fill=red!30,draw, circle] (n6) at (3,1) {};
            \draw[red!30,-] (n1)-- node[pos=0.6, left] {} (n2);
            \draw[red!30,-] (n2)-- node[pos=0.35,right] {} (n3);
            \draw[PineGreen!30,-] (n3)-- node[pos=0.6,right] {}(n4);
            \draw[red!30,-] (n4)-- node[pos=0.45,left] {}(n1);
            \draw[red!30,-] (n3)-- node[pos=0.65,left] {}(n6);
            \draw[PineGreen!30,-] (n6)-- node[pos=0.4,right] {}(n5);
            \draw[red!30,-] (n5)-- node[pos=0.4,left] {}(n3);
            }
        \end{tikzpicture}
        \end{onlyenv}
     \end{center}
        ...
        \resizebox{0.7\textwidth}{!}{
            \begin{tikzpicture}
                        \graphbox{\(\)}{0mm}{0mm}{34mm}{15mm}{-10mm}{-10mm}{
                            \node[red!30,fill=red!30,draw, circle] (x) at (0,0) {};
                            \node () at (0,0.55) {};  
                            \node[PineGreen!30,fill=PineGreen!30,draw, circle] (y) at (2,0) {};
                            \node () at (2,0.55) {};
                            \draw[PineGreen!30,-] (x) -- node[midway,above] {} (y) ;
                        ...
                        \graphbox{\(\)}{40mm}{0mm}{34mm}{15mm}{-10mm}{-10mm}{
                            \node[red!30,fill=red!30,draw, circle]  (x) at (0,0) {};  
                            \node () at (0,0.55) {};  
                            \node[red!30,fill=red!30,draw, circle]  (y) at (2,0) {};
                            \node () at (2,0.55) {};
                            \draw[red!30,-] (x) -- node[midway,above] {} (y) ;
                            % \draw[->] (x) edge [loop above] node {$A$} (x);
...
\begin{frame}{A Non-Termination Case}
    ...
    \begin{tikzpicture}[baseline=-10mm]
        ...
        \node[PineGreen!30,fill=PineGreen!30,draw,circle] (x) at (0,0) {};
        \node[red!30,fill=red!30,draw,circle] (y) at (1,0) {};
        \draw[-] (x) -- node[midway,below] {} (y) ;
        }  

        \graphbox{}{30mm}{-3mm}{20mm}{10mm}{-5mm}{-5mm}{
        \node[red!30,fill=red!30,draw,circle] (x) at (0,0) {};
        \node[PineGreen!30,fill=PineGreen!30,draw,circle] (y) at (1,0) {};
        \draw[-] (x) -- node[midway,below] {} (y) ;
        }    
...
\begin{frame}{Automated Termination Proofs}
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{ 
       Number of edges: \begin{tikzpicture}[baseline=-12mm]
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{ 
       Number of nodes: \begin{tikzpicture}[baseline=-12mm]
                    \graphbox{}{0mm}{-3mm}{34mm}{15mm}{0mm}{4mm}{
                        \coordinate (o) at (0mm,-11mm); 
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{ 
       Number of edges labeled by $a$: \begin{tikzpicture}[baseline=-12mm]
                    \graphbox{}{0mm}{-3mm}{34mm}{15mm}{0mm}{4mm}{
                        \coordinate (o) at (0mm,-11mm); 
                        \node[draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                        \node[draw,circle] (l2) at ($(l1)+(2,0)$) {};
...
\begin{frame}{A Non-Trivial Example}
    \begin{center}
      \resizebox{\textwidth}{!}{
       \begin{tikzpicture}[baseline=-10mm]
  ...
  \begin{description}
    \item[Limitation of simple interpretations] 
    \item[Need a formal definition of graph transformations]\ \\
        \begin{itemize}
            \item edges incident to deleted nodes
        \end{itemize}
  \end{description}
\end{frame}
...
\begin{frame}{Graph Morphisms: Structure-Preserving Functions}
          ...
          \resizebox{\textwidth}{!}{
          \begin{tikzpicture}
            \graphbox{\( G \)}{0mm}{-20mm}{43mm}{25mm}{2mm}{-10mm}{
                \coordinate (o) at (-7mm,-8mm); 
                \node[draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {1};
                \node[draw,circle] (l2) at ($(l1)+(3,0)$) {2};
                \node[draw,circle] (l3) at ($(l1)+(1,0)$) {3};
            ...
            \graphbox{\( H \)}{52mm}{-20mm}{45mm}{25mm}{2mm}{-10mm}{
                \coordinate (o) at (-07mm,-8mm); 
            ...
            \draw[->](44mm,-33mm) -- node [midway,above] {\( h \)} (51mm,-33mm);
        \end{tikzpicture}
          }
         \end{center}
    ...
    \newline 
    \newline
   $\overset{h}{\rightarrow}$ indicates $h: G \rightarrow H$.
\end{frame}
        ...
        \begin{center}
                \begin{tikzpicture}
                    \graphbox{}{0mm}{0mm}{34mm}{15mm}{2mm}{0mm}{
                        ...
                        \node[PineGreen!30,fill=PineGreen!30,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                        \node[red!30,fill=red!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
                        \node[draw,circle] (l3) at ($(l1)+(1,0)$) {};
                    ...
                    \graphbox{}{40mm}{0mm}{34mm}{15mm}{2mm}{0mm}{
                        \coordinate (o) at (0mm,-8mm); 
                        \node[PineGreen!30,fill=PineGreen!30,draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                        \node[red!30,fill=red!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
                    }  
                    ...
                    \graphbox{ }{0mm}{-22mm}{34mm}{25mm}{2mm}{-5mm}{
                        ...
                        \node[red!30,fill=red!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
                        \node[draw,circle ] (l3) at ($(l1)+(1,0)$) {};
                        \node[blue!30,fill=blue!30,draw,circle] (l4) at ($(l2)+(0,-1)$) {};
                        \draw[->] (l1) -- (l3) node[midway,above] {};
                        \draw[->] (l3) -- (l2) node[midway,above] {};
...
\begin{beamercolorbox}[rounded=true,shadow=true,wd=\textwidth]{block body}
    ...
    \begin{itemize}
        ...
        \item<3->{universality:} \color{PineGreen}for all $(\gamma,\gamma')$,if $\square ABEC$ is commutative, then there is a unique $\delta$ such that \text{$\triangle BDE$} and $\triangle CDE$ are commutative.\color{black}
    \end{itemize} 
\end{beamercolorbox}
...
\begin{minipage}[t]{0.25\textwidth}
  \begin{overlayarea}{0.25\textwidth}{0.6\textheight}
        ...
        \begin{tikzpicture}  
            \coordinate (k) at (0, 0);
            \draw[fill=black!30,black!30] ($(k)+(0,0)$) rectangle ($(k)+(0.5,0.5)$);
            % \node () at ($(k)+(0.25,0.25)$) {\( \mathrm{K} \)};
        
            \coordinate (c) at (0, -2.2);
            \draw[fill=blue!20,blue!20]
            ($(c)+(0,-0.5)$)
            -- ($(c)+(0,0.5)$) 
            -- ($(c)+(1,0.5)$) 
            ...
            \draw[fill=black!30,black!30] ($(c)+(0,0)$) rectangle ($(c)+(0.5,0.5)$);
            % \node () at ($(c)+(0.25,0.25)$) {\( \mathrm{K} \)};
    
            \coordinate (r) at (3,0);
            \draw[fill=red!20,red!20] ($(r)+(-0.5,0)$)
            -- ($(r)+(-0.5,0.5)$)
            -- ($(r)+(0,1)$)
            --  ($(r)+(0.5,1)$)
            -- ($(r)+(0.5,0)$)
            ...
            \draw[fill=black!30,black!30] ($(r)+(0,0)$) rectangle ($(r)+(0.5,0.5)$);
            ...
            arc[start angle=0, end angle=-90, radius=1]
            -- cycle;
            \draw[fill=red!20,red!20] ($(h)+(-0.5,0)$)
            -- ($(h)+(-0.5,0.5)$)
            -- ($(h)+(0,1)$)
            --  ($(h)+(0.5,1)$)
            -- ($(h)+(0.5,0)$)
        ...
        \draw[fill=black!30,black!30] ($(h)+(0,0)$) rectangle ($(h)+(0.5,0.5)$);
        ...
        \resizebox{!}{1.2\textwidth}{
             ...
             \begin{tikzpicture}
              \graphbox{}{0mm}{5mm}{34mm}{20mm}{2mm}{-5mm}{
                 \coordinate (o) at (0mm,-8mm); 
                  \node[black!30,fill=black!30,draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                  \node[black!30,fill=black!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
              } 
              ...
              \graphbox{}{40mm}{5mm}{34mm}{20mm}{2mm}{-5mm}{
                \coordinate (o) at (0mm,-8mm); 
                  \node[black!30,fill=black!30,draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                  \node[black!30,fill=black!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
                  \node[red!30,draw,circle,fill=red!30] (l3) at ($(l1)+(1,0)$) {};
                  \draw[red!30] (l1) -- (l3) node[midway,above] {};
                  \draw[red!30] (l3) -- (l2) node[midway,above] {};
              }  
              ...
              \graphbox{}{0mm}{-22mm}{34mm}{30mm}{2mm}{-10mm}{
                \coordinate (o) at (0mm,-3mm); 
                  \node[black!30,fill=black!30,draw,circle] (l1) at ($(o)+(-10mm,0mm)$) {};
                  \node[black!30,fill=black!30,draw,circle] (l2) at ($(l1)+(2,0)$) {};
                  \node[blue!30,draw,circle,fill=blue!30] (l4) at ($(l2)+(0,-1)$) {};
                  \draw[blue!30] (l2) -- (l4) node[midway,right] {};
                %   \node[blue,draw,circle] (l6) at ($(l1)+(0,-1)$) {7};
                %   \draw[blue,<-] (l1) -- (l6) node[midway,left] {$a$};
                    \node[blue!30,draw,circle,fill=blue!30] (l7) at ($(l4)+(-1,0)$) {};
                  \draw[blue!30] (l4) -- (l7) node[midway,below] {};
              }    
...
\begin{frame}{Graph Rewriting with Double-Pushout (DPO)}
  ...
  \begin{center}
   ...
   Remark:
   \begin{itemize}
    \item No implicit edge deletion
   \end{itemize}
\end{overlayarea}
\end{frame}
...
G &\leadsto \mathcal{F}(G,T) \\
  ...
  &\leadsto \operatorname{aggregator}(\mathrm{weight}(\mathcal{F}(G,T)))\in\mathbb{N}
\end{flalign*}
...
\begin{frame}{Graph Weight} 
    \begin{beamercolorbox}[rounded=true,shadow=true,wd=\textwidth]{block body}
        The weight of a graph $L$ is \[\min \{h : L \mathop{\to} T \mid \opn{weight}_T(h)\}\]
    \end{beamercolorbox}
    \begin{center}
        \resizebox{1\textwidth}{!}{
            \begin{tikzpicture}
                ...
                \graphbox{$T$}{-42mm}{10mm}{35mm}{40mm}{-10mm}{-20mm}{
                ...
                \graphbox{$T$}{47mm}{10mm}{35mm}{40mm}{-10mm}{-17mm}{
    ...
    \end{center}
        ...
        $\opn{weight}_T(L) \mathop{=} \min \{\opn{weight}_T(h_1),\opn{weight}_T(h_2)\} = \min \{1+1, 1+0\}\mathop{=} 1$       
\end{frame}
...
\begin{frame}{Termination Criterion}
    ...
    \end{center}
      ...
      \begin{beamercolorbox}[rounded=true,shadow=true,wd=\textwidth]{block body}
        ...
        \begin{itemize}
        \item for all \textcolor{blue}{$t_K$}, if there is \textcolor{PineGreen}{$t_L$} making $\triangle KLT$ commutative, then 
        \begin{flalign*}
            &\min \{\opn{weight}_T(\textcolor{PineGreen}{t_L}) \mid \triangle KLT \text{commutative}\}  
            \\ \mathop{>}
            &\min \{\opn{weight}_T(\textcolor{red}{t_R}) \mid \triangle KRT \text{commutative}\}  
        \end{flalign*}
        \end{itemize} 
    \end{beamercolorbox}
...
\end{frame}
\begin{frame}{Searching for Weighted Type Graphs}
...
\resizebox{\textwidth}{!}{
    ...
    \node[startstop] (start) {Start program};
    \node[process, below=of start] (select) {Select graph rewriting system};
    \node[decision, below=of select] (choose) {Choose a method};
    \node[process, below=of choose] (apply) {try to eliminate some rules};
    \node[decision, below=of apply] (check) {Is the system simplified?};
    \node[decision, left=22mm of check] (trynext) {Try the next algorithm?};
    \node[decision, right=22mm of check] (empty) {Is the system empty?};
    \node[startstop, below=of check] (end) {End};
    ...
    \draw[->] (empty) -- node[midway,above]{Non} (choose);
