...
\vspace{-3mm}
\begin{flalign*}
G &\leadsto \mathcal{Morphisms}(G,T) \\
  &\leadsto \mathrm{weight}(\mathcal{Morphisms}(G,T)) \\
  &\leadsto \mathrm{aggregator}(\mathrm{weight}(\mathcal{Morphisms}(G,T)))\in\mathbb{N}
\end{flalign*}
...
With weights in $\mathbb{N}$:
    ...
    \begin{tabular}{ |c|c|c|c| } 
    \hline
    \textcolor{red}{\# nodes (k)}&  \textcolor{red}{\# labels (m)} & \textcolor{red}{\# weights} & \# possibilities \\ 
    \hline
    2 & 2 & 2 & $\approx 10^{4}$ \\ 
    \hline
    3 & 3 & 3 & $\approx  10^{21}$ \\ 
...
\vspace{-4mm}
    ...
    \hline
    \textcolor{red}{\# nodes (k)}&  \textcolor{red}{\# labels (m)} & \textcolor{red}{\# variables}& \# linear programs in $\mathbb{R}$\\ 
    \hline
    2 & 2 & 8 & $\approx 10^{2}$ \\ 
    \hline
    3 & 3 & 27 & $\approx 10^{8}$ \\ 
    ...
    \end{tabular}
    \end{center}
    Linear programs can be solved in polynomial time with respect to the number of variables on average by Z3.
\end{frame}
...
\begin{frame}{Capability Improvement: Morphism Counting}
    ...
    Interpretation:
        \vspace{-3mm}
        \begin{flalign*}
        G &\leadsto |\mathcal{Morphisms}(X,G)| \in\mathbb{N}
        \end{flalign*}
\end{frame}
