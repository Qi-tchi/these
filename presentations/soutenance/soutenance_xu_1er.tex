 ...
 Graph representing a configuration of a distributed system:
    \begin{overlayarea}{\textwidth}{\textheight}
        ...
        \begin{onlyenv}<2>
            \begin{tikzpicture}
            \graphbox{}{0mm}{0mm}{45mm}{35mm}{-14mm}{-17mm}{
            \node[PineGreen,draw, circle, label={[label distance=-1mm]left:{\textcolor{PineGreen}{$N$}}}] (n1) at (0,0) {};
            \node[draw, circle, label={[label distance=-1mm]above:{$N$}}] (n2) at (1,1) {};
            \node[draw, circle, label={[label distance=-1mm]above:{$N$}}] (n3) at (2,0) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]below:{\textcolor{PineGreen}{$A$}}}] (n4) at (1,-1) {};
            \node[draw, circle, label={[label distance=-1mm]below:{$N$}}] (n5) at (3,-1) {};
            \node[draw, circle, label={[label distance=-1mm]above:{$N$}}] (n6) at (3,1) {};
            \draw[-] (n1)-- node[pos=0.6, left] {$0$} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[-] (n3)-- node[pos=0.6,right] {$0$}(n4);
            \draw[PineGreen,-] (n4)-- node[pos=0.45,left] {$0$}(n1);
            \draw[-] (n3)-- node[pos=0.65,left] {$0$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        ...
        \end{onlyenv}
         \begin{onlyenv}<3>
            ...
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[-] (n3)-- node[pos=0.6,right] {$0$}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[-] (n3)-- node[pos=0.65,left] {$0$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        ...
        \begin{onlyenv}<4>
            ...
            \node[red,draw, circle, label={[label distance=-1mm]left:{\textcolor{red}{$A$}}}] (n1) at (0,0) {};
            \node[draw, circle, label={[label distance=-1mm]above:{$N$}}] (n2) at (1,1) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]above:{\textcolor{PineGreen}{$N$}}}] (n3) at (2,0) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]below:{\textcolor{PineGreen}{$A$}}}] (n4) at (1,-1) {};
            \node[draw, circle, label={[label distance=-1mm]below:{$N$}}] (n5) at (3,-1) {};
            \node[draw, circle, label={[label distance=-1mm]above:{$N$}}] (n6) at (3,1) {};
            \draw[-] (n1)-- node[pos=0.6, left] {$0$} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[PineGreen,-] (n3)-- node[pos=0.6,right] {\textcolor{PineGreen}{$0$}}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[-] (n3)-- node[pos=0.65,left] {$0$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
        ...
        \begin{onlyenv}<5>
            ...
            \draw[-] (n1)-- node[pos=0.6, left] {$0$} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[red,-] (n3)-- node[pos=0.6,right] {\textcolor{red}{$1$}}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[-] (n3)-- node[pos=0.65,left] {$0$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
        ...
        \end{onlyenv}
          \begin{onlyenv}<6>
            \begin{tikzpicture}
            \graphbox{}{0mm}{0mm}{45mm}{35mm}{-14mm}{-17mm}{
            \node[PineGreen,draw, circle, label={[label distance=-1mm]left:{\textcolor{PineGreen}{$A$}}}] (n1) at (0,0) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]above:{\textcolor{PineGreen}{$N$}}}] (n2) at (1,1) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]above:{\textcolor{PineGreen}{$A$}}}] (n3) at (2,0) {};
            \node[red,draw, circle, label={[label distance=-1mm]below:{\textcolor{red}{$A$}}}] (n4) at (1,-1) {};
            \node[draw, circle, label={[label distance=-1mm]below:{$N$}}] (n5) at (3,-1) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]above:{\textcolor{PineGreen}{$N$}}}] (n6) at (3,1) {};
            \draw[PineGreen,-] (n1)-- node[pos=0.6, left] {\textcolor{PineGreen}{$0$}} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[red,-] (n3)-- node[pos=0.6,right] {\textcolor{red}{$1$}}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[PineGreen,-] (n3)-- node[pos=0.65,left] {$0$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        \end{tikzpicture}
        \end{onlyenv}
         \begin{onlyenv}<7>
            ...
            \draw[red,-] (n1)-- node[pos=0.6, left] {$1$} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[red,-] (n3)-- node[pos=0.6,right] {$1$}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[red,-] (n3)-- node[pos=0.65,left] {$1$}(n6);
            \draw[-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        \end{tikzpicture}
        ...
        \begin{onlyenv}<8>
            ...
            \node[red,draw, circle, label={[label distance=-1mm]above:{\textcolor{red}{$A$}}}] (n3) at (2,0) {};
            \node[red,draw, circle, label={[label distance=-1mm]below:{\textcolor{red}{$A$}}}] (n4) at (1,-1) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]below:{\textcolor{PineGreen}{$N$}}}] (n5) at (3,-1) {};
            \node[PineGreen,draw, circle, label={[label distance=-1mm]above:{\textcolor{PineGreen}{$A$}}}] (n6) at (3,1) {};
            \draw[red,-] (n1)-- node[pos=0.6, left] {$1$} (n2);
            \draw[-] (n2)-- node[pos=0.35,right] {$0$} (n3);
            \draw[red,-] (n3)-- node[pos=0.6,right] {$1$}(n4);
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[red,-] (n3)-- node[pos=0.65,left] {$1$}(n6);
            \draw[PineGreen,-] (n6)-- node[pos=0.4,right] {$0$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        \end{tikzpicture}
        \end{onlyenv}
        \begin{onlyenv}<9->
            ...
            \draw[red,-] (n4)-- node[pos=0.45,left] {$1$}(n1);
            \draw[red,-] (n3)-- node[pos=0.65,left] {$1$}(n6);
            \draw[red,-] (n6)-- node[pos=0.4,right] {$1$}(n5);
            \draw[-] (n5)-- node[pos=0.4,left] {$0$}(n3);
            }
        \end{tikzpicture}
        \end{onlyenv}
        ...
        \begin{center}
                \begin{tikzpicture}
                    ...
                    \graphbox{ }{0mm}{-22mm}{34mm}{25mm}{2mm}{-5mm}{
                        ...
                        \node[draw,circle] (l2) at ($(l1)+(2,0)$) {2};
                        \node[draw,circle ] (l3) at ($(l1)+(1,0)$) {3};
                        \node[draw,circle] (l4) at ($(l2)+(0,-1)$) {4};
                        \draw[->] (l1) -- (l3) node[midway,above] {};
                        \draw[->] (l3) -- (l2) node[midway,above] {};
...
\begin{frame}{Conclusion and Future Work}
    Contributions:
    \begin{itemize} 
        \item an extension of an existing method for greater usability
        \item a new termination criterion for greater power
        \item an automated tool for termination analysis
    \end{itemize}
    Future work:
    \begin{itemize}
        \item formal verification of the methods
