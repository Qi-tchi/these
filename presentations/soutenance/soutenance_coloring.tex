...
\begin{frame}{Graph Transformation}
  ...
  Intuitive modelization of distributed systems:
    \begin{itemize}
...
\begin{frame}{Graph Transformation}
 ...
 \only<12->{A spanning tree is obtained when the rule cannot be applied:}
    ...
    Apply the rule as long as possible:
        ...
        \end{center}
        This rule replaces an occurrence of the left-hand side by the right-hand side.\\
        \begin{onlyenv}<13->
...
\begin{frame}{Morphisms by Image Node Colors}
 ...
 \begin{center}
   ...
   An $X$-occurrence $x$ is 
    \begin{itemize}
        \item \textcolor{orange}{orange} if $\opn{Im(x)}$ contains only \textcolor{black}{white} and \textcolor{orange}{orange} nodes;
        \item \textcolor{red}{red} if 
            $\opn{Im(x)}$ contains only \textcolor{black}{white} and \textcolor{red}{red} nodes; 
        \item \textcolor{blue}{blue} if 
            $\opn{Im(x)}$ contains only \textcolor{black}{white} and \textcolor{blue}{blue} nodes;
        \item \textcolor{blue}{blue}-and-\textcolor{orange}{orange} if $\opn{Im(x)}$ contains both \textcolor{blue}{blue} and \textcolor{orange}{orange} nodes;
        \item \textcolor{blue}{blue}-and-\textcolor{red}{red} if $\opn{Im(x)}$ contains both \textcolor{blue}{blue} and \textcolor{red}{red} nodes.
    \end{itemize}
\end{frame}
