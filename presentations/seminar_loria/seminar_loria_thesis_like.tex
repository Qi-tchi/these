...
\begin{frame}{Context and Objective of the Thesis}
\begin{itemize}
    \item Ubiquity of distributed and concurrent algorithms
        \begin{itemize}
            \item Medical devices, transportation systems, ...
        \end{itemize}
    \item Severe consequences of errors
        \begin{itemize}
            \item Threats to human life, data loss, ...
        \end{itemize} 
    \item Ensuring correct behaviour of such systems is challenging
    \item Automated verification methods
        \begin{itemize}
            \item Mathematically rigorous methods
            \item Require little user intervention
        \end{itemize} 
\end{itemize}
\end{frame}
...
\begin{frame}{Graph Transformation}
   ...
   Graph rewriting:
    \begin{itemize}
        ...
        \item algorithm behaviors $\rightarrow$ graph transformation rules that depend on the states of neighboring nodes and edges.
    \end{itemize}
\end{frame}
 ...
 Graph representing a configuration of a distributed system:
    ...
    \begin{overlayarea}{\textwidth}{\textheight}
        ...
        \begin{onlyenv}<1>
            ...
            \node[red, draw, circle, label={[label distance=-1mm]below:{$A$}}] (n4) at (1,-1) {};
...
\begin{frame}{Termination of graph transformation systems}
  \begin{itemize}
    ...
    \item No graph can be transformed forever
...
%       }
%   \end{center}
    \begin{corollary}{of Bruggink et al. 2014~\cite{bruggink2014termination}}
        Every rewriting step strictly decreases the weight if 
        \begin{itemize}
...
existential Presburger arithmetic formula} with:
                \begin{itemize}
...
\begin{frame}{Conclusion and Future Work}
    ...
    Future work:
    \begin{itemize}
        \item Morphism counting with forbidden contexts,
        \item Formal proof of correctness using a proof assistant,     
        \item Certificate-generation mechanism,
