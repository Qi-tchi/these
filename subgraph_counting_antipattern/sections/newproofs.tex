...
\begin{proof}
    ...
    \begin{center}
        ...
        \end{center} 
    Since $R'XHR$ is a pullback square, by the universal property Definition~\ref{def:cat:pb}, there exists a unique morphism $h_{AR'} \colon A \to R'$ such that 
    \begin{flalign}
    ...
    \begin{flalign*}
        ...
        &= h_{AR'} \star h_{R'R} &\text{by Equation~\eqref{hakpkprparp}} \\
        &= h_{AK} \star h_{KR} &\text{by Equation~\eqref{harprprakkr}}
    \end{flalign*}
...
\begin{lemma}
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    There exists a unique monomorphism $h_{XG}:X \rightarrowtail G$ such that $h_{C'C} \star h_{CG} = h_{C'X} \star h_{XG}$ and  $h_{R'L} \star h_{LG} = h_{R'X} \star h_{XG}$.
\end{lemma}
\begin{proof}
    There exists a unique morphism $h_{XG}:X \to G$, by Definition~\ref{def:cat:po}, because $K'C'XR'$ is a pushout\todo{$K'C'XR'$ PO} and 
             ...
             Therefore, we have the contradiction:
                ...
                \begin{flalign*}
                    h_{XG}(x_1) &= h_{XG}(h_{C'X}(c')) & \text{by definition of $c'$} \\
                            ...
                            \\
                            &\neq (h_{KC} \star h_{CG})(k_2)  & \text{by injectivity of $h_{KC}\star h_{CG}$ and Equation~\eqref{k1neqk2}} 
                            \\
...
\begin{lemma}
    ...
    Let $X$ be a graph. Let $\rho=(L \overset{l}{\leftarrowtail} K \overset{r}{\rightarrowtail} R)$ be an injective DPO rewriting rule which is \(X\)-non-increasing under $\Psi$. Let $G \Rightarrow_{\rho,\mathcal{M}} H$ be a rewriting step defined by the following DPO diagram:
...
\begin{proof}
    ...
    %                         &= (h_{KC} \star h_{CG})(k_1) & 
    %                         \\
    %                         &\neq (h_{KC} \star h_{CG})(k_2) & \text{by Equation~\eqref{k1_neq_k2} and injectivity of $h_{KC} \star h_{CG}$} 
    %                         \\
