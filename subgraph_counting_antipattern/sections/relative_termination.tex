...
%     % Let \(\Rightarrow\) be rewriting relation.
%     % A \textbf{\(\Rightarrow\)-sequence} is a finite sequence \(s_0,s_1,\hdots, s_m\) of objects such that \(s_n \Rightarrow s_{n+1}\) for each \( 0 \leq n \leq m-1\), or an infinite sequence \(s_0,s_1,\hdots\) of objects such that \(s_n \Rightarrow s_{n+1}\) for each \(n \in \mathbb{N}\).
%  Let $\Rightarrow$ denote a rewriting relation. A $\Rightarrow$-sequence is defined as either a sequence $(s_i)_{0 \leq i \leq m}$ where $m \in \mathbb{N}\cup \{+\infty\}$ and for all $0 \leq i \leq m-1$, $s_i \Rightarrow s_{i+1}$.
% %  , or an infinite sequence $s_0, s_1, \dots$ of objects such that $s_n \Rightarrow s_{n+1}$ for all $n \in \mathbb{N}$.
% \end{definition}
\begin{definition}[Rewriting sequence]  
