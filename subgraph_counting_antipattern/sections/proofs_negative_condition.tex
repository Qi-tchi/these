...
\noindent
\begin*{\textbf{\autoref{antipattern:lem:xglnotmlp_xhlnotmrp}}}
    \newline
    \noindent
    \vspace{2mm}
    \begin{minipage}{0.7\textwidth}\setlength{\parindent}{1em}
...
\noindent
\begin*{\textbf{\autoref{antipattern:lem:xglnotmlnotlp_xhlnotmrnotrp}}}
    \newline
    \noindent
    \vspace{2mm}
    \begin{minipage}{0.7\textwidth}\setlength{\parindent}{1em}
...
\begin{center}
    ...
    We have $h_{XH} = h_{XF} \star h_{FH}$ because $K'C'XL'$ is a pushout and $h_{XH}$ 
        ...
        \begin{flalign}
           ...
           &=  h_{C'C''} \star h_{C''C} \star h_{CH} \hspace{2cm} \text{by~\eqref{antipattern:cpcppc}}
        \end{flalign} and 
        \begin{flalign}
        h_{L'X} \star h_{XH} &= h_{L'R} \star h_{RH} \\
        &= h_{L'L''} \star h_{L''R} \star h_{RH} \hspace{2cm} \text{by~\eqref{antipattern:lplpplppllpl}}
        \end{flalign}
         but we have 
        \begin{flalign*}
