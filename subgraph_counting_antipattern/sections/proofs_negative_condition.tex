...
\begin{proof}
    ...
    There is, thus, an injection from $(\operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}}\mathop{\setminus} \{
                h_{XL} \mathop{\in} \operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}} \mid 
                \exists h_{FG}. h_{XL} \mathop{\star} m \mathop{=} f \mathop{\star} h_{FG}
            \}) \mathop{\star} m$ to $\operatorname{Mono}(\mathcal{X},G,m)_{\operatorname{NF}}$. Since $(\operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}}\mathop{\setminus} \{
                h_{XL} \mathop{\in} \operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}} \mid 
                \exists h_{FG}. h_{XL} \mathop{\star} m \mathop{=} f \mathop{\star} h_{FG}
            \}) \mathop{\star} m$ and $\operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}}\mathop{\setminus} \{
                h_{XL} \mathop{\in} \operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}} \mid 
                \exists h_{FG}. h_{XL} \mathop{\star} m \mathop{=} f \mathop{\star} h_{FG}
            \}$ are in bijection, we conclude that there is an injection from $\operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}}\mathop{\setminus} \{
                h_{XL} \mathop{\in} \operatorname{Mono}(\mathcal{X},L)_{\operatorname{NF}} \mid 
                \exists h_{FG}. h_{XL} \mathop{\star} m \mathop{=} f \mathop{\star} h_{FG}
...
\begin{proof}
   ...
   \card{\operatorname{Mono}(X,R)}
    \end{flalign*}
    which is true because $\card{\operatorname{Mono}(X,G,m)} \mathop{=} \card{\operatorname{Mono}(X,L)}$ and $\card{\operatorname{Mono}(X,H,m')} =
   \card{\operatorname{Mono}(X,R)}$ by Lemma~\ref{subgraph_counting:lem:decomp_w_u}.
...
\begin*{\textbf{Lemma~\ref{antipattern:lem:xglnotmlp_xhlnotmrp}}}
    ...
    \begin{minipage}{0.7\textwidth}\setlength{\parindent}{1em}
        ...
        %  with underlying graph $X$ 
         and \( \rho \mathop{=} (L \overset{l}{\leftarrowtail} K \overset{r}{\rightarrowtail} R) \) be a rule. 
...
%    \end{tikzpicture}
   ...
   Thus, we have \begin{flalign*}
    ...
    It remains to show that $\phi(h_{XG})$ can be decomposed as $x \mathop{\star} y$ with $x: X \rightarrowtail F$ and $y: F \rightarrowtail H$. There are three mutually exclusive cases according to whether or not the morphism $h_{FG}$ can be factorized by $m$ or $l'$.
        \begin{center}
    \begin{tikzpicture}
        \node (k) at (0,1) {K};
        \node (l) at (-2,1) {L};
    ...
    \begin{itemize}
        \item Case 1 : there exists $h_{FL}: F \mathop{\rightarrow} L$ such that $h_{FG} \mathop{=} h_{FL} \mathop{\star} m$. 
        ...
        \item Case 2 : there does not exist $h_{FL}: F \mathop{\rightarrow} L$ such that $h_{FG} \mathop{=} h_{FL} \mathop{\star} m$, but there exists $h_{FC}:F \mathop{\rightarrow} C$ such that $h_{FG} \mathop{=} h_{FC} \mathop{\star} l'$. 
        We have the following commutative diagram:
    ...
    \item Case 3 : there does not exist $h_{FL}: F \mathop{\rightarrow} L$ such that $h_{FG} \mathop{=} h_{FL} \mathop{\star} m$,
    and there does not exist $h_{FC}:F \mathop{\rightarrow} C$ such that $h_{FG} \mathop{=} h_{FC} \mathop{\star} l'$.
...
\begin*{\textbf{Lemma~\ref{antipattern:lem:xglnotmlnotlp_xhlnotmrnotrp}}}
    ...
    \vspace{2mm}
    \begin{minipage}{0.7\textwidth}\setlength{\parindent}{1em}
        Let $\mathcal{X}$ be a ruler-graph with underlying graph $X$, and let \( \rho \mathop{=} (L \overset{l}{\leftarrowtail} K \overset{r}{\rightarrowtail} R) \) be a rule. Suppose that $\rho$ and $\rho^{-1}$ are $X$-non-increasing.
        Consider the DPO diagram illustrated on the right. We have 
    \end{minipage}%
    \begin{minipage}{0.29\textwidth}
        \hfill
...
\begin{proof} 
 ...
 $
    ...
    that we can construct an injection $\phi: \operatorname{Mono}(\mathcal{X},G,\lnot m, \lnot l')_{\operatorname{F}} \mathop{\to} \operatorname{Mono}(\mathcal{X},H,\lnot m', \lnot r')_{\operatorname{F}}$.
    ...
    \begin{center}
        ...
        \end{center} 
         ...
         \todo{assmption: $\rho^{-1}$ is $X$-non-increasing} There exists a monomorphism $h_{L'R} : L' \rightarrowtail R$ because $\rho^{-1}$ is $X$-non-increasing by assumption. By Lemma~\ref{lem:g_monic}, we can construct the following commutative diagram:
   ...
   Since we work in \textbf{Graph}, we can construct $C'' \leftarrowtail K'' \rightarrowtail L''$ the pullback of $C'' \rightarrowtail F \leftarrowtail L''$, and the following commutative diagram holds:
    \begin{center}
            ...
            Since $K''C''FL''$ is pullback and $K'C'C''FL''L'$ is a commutative diagram, by the universal property of pullback, there exist unique morphisms $h_{K'K''}:K' \rightarrowtail K''$ such that $K'C'C''K''$, $K'L'L''K''$ in the following diagram are commutative:
            \begin{center}
            \resizebox{0.5\textwidth}{!}{
                \begin{tikzpicture}
                    \node (k) at (-2,0) {K};
          ...
          Similarly, since $KCGL$ is pullback and $K''C''CGLL''$ is a commutative diagram, by the universal property of pullback, there exist unique morphisms $h_{K''K}:K'' \rightarrowtail K$ such that $K''C''CK$, $K''L''LK$ in the following diagram are commutative:
 \begin{center}
            \resizebox{0.5\textwidth}{!}{
                \begin{tikzpicture}
                    \node (k) at (-2,0) {K};
        ...
        There is a monomorphism $h_{L''R}:L'' \rightarrowtail R$ such that $K''L''RK$ is pullback, because $\rho^{-1}$ is $X$-non-increasing by assump.\todo{$\rho^{-1}$ is $X$-non-increasing} We have, thus, the following commutative diagram:
...
%     % There exists $h_{L'L''}:L' \rightarrowtail L''$ such that $h_{L'L} \mathop{=} h_{L'L''} \mathop{\star} h_{L''L}$ 
...
\begin{enumerate}
    \item\label{antipattern:thm:termination_grs:assump:1}  for every $\rho \mathop{\in} \mathcal{A} \mathop{\cup} \mathcal{B}$ and for every \( \mathcal{X} \mathop{\in} \mathbb{X} \) with underlying graph $X$, 
    ...
    \item\label{antipattern:thm:termination_grs:assump:2}  for every \(\rho \mathop{\in} \mathcal{A}\), 
    % \( w_{s_\mathbb{X}}(lhs(\rho)) \mathop{>} w_{s_\mathbb{X}}(rhs(\rho)) \),
    \( \sum_{\mathcal{X} \mathop{\in} \mathbb{X}}^{}s_\mathbb{X}(\mathcal{X}) * \left( 
        \card{\operatorname{Mono}(X,L)} -
        \card{\operatorname{Mono}(X,R)}
        \right) \mathop{>} 0 \),
    \item\label{antipattern:thm:termination_grs:assump:3}  for every \(\rho \mathop{\in} \mathcal{B}\),  
