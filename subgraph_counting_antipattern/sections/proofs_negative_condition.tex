...
\begin{proof}
    ...
    \begin{flalign*}
        h_{XH} 
        &= h_{XC} \star r' \\
        &= (h_{XK} \star u) \star r' \hspace{1cm} by Equation~\eqref{alabeldkfsjlk}\\
        &= h_{XK} \star (r \star m') \\ 
        &= (h_{XK} \star r) \star m' 
    \end{flalign*}
...
%    \end{tikzpicture}
   ...
   Thus, we have \begin{flalign*}
        h_{XG} &= h_{XC} \star l' \\
        &= (h_{XK} \star u) \star l' &\text{by Equation~\eqref{antipattern:eq:hxk_u}}\\
    ...
    \begin{itemize}
        ...
        \begin{flalign*}
             h_{XC} \star l' = &h_{XG}  & \text{by Equation~\eqref{antipattern:lem:hxghxclp}}\\
             = &f \star h_{FG} 
...
\begin{center}
    ...
    We have $h_{XH} = h_{XF} \star h_{FH}$ because $K'C'XL'$ is a pushout and $h_{XH}$ 
        ...
        \begin{flalign}
           ...
           &=  h_{C'C''} \star h_{C''C} \star h_{CH} \hspace{2cm} \text{by Equation~\eqref{antipattern:cpcppc}}
        \end{flalign} and 
        \begin{flalign}
        h_{L'X} \star h_{XH} &= h_{L'R} \star h_{RH} \\
        &= h_{L'L''} \star h_{L''R} \star h_{RH} \hspace{2cm} \text{by Equation~\eqref{antipattern:lplpplppllpl}}
        \end{flalign}
         but we have 
        \begin{flalign*}
...
\begin{proof} 
    ...
    \end{itemize}
    Since $w_{s_\mathbb{X}}(G) \in \mathbb{N}$ for all graph $G$. Every rewriting chain can only have a finite number of rewriting steps using rules from $\mathcal{A}$.
\end{proof} 