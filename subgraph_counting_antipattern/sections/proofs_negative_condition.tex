...
\begin{lemma}
    ...
    Let $\mathcal{X} \mathop{=} (X, \set{f:X \rightarrowtail F})$ be a ruler-graph and \( \rho \mathop{=} (L \overset{l}{\leftarrowtail} K \overset{r}{\rightarrowtail} R) \) be a rule. Consider the DPO diagram shown below.
        \begin{center}
            \begin{tikzpicture}
                % [node distance=15mm]
                \node (I) {$K$};
...
\begin*{\textbf{Lemma~\ref{antipattern:lem:xglnotmlp_xhlnotmrp}}}
        ...
        Suppose that $\rho^{-1}$ is $F$-non-increasing if $\mathcal{C} \mathop{=} \set{f:X \rightarrowtail F}$. For the DPO shown below,
        \begin{center}
        \begin{tikzpicture}
            % [node distance=15mm]
            \node (I) {$K$};
...
\begin*{\textbf{Lemma~\ref{antipattern:lem:xglnotmlnotlp_xhlnotmrnotrp}}}
        let \( \rho \mathop{=} (L \overset{l}{\leftarrowtail} K \overset{r}{\rightarrowtail} R) \) be a rule, and let $\mathcal{X}=(X,\mathcal{C})$ be a ruler-graph. Suppose that $\rho$ and $\rho^{-1}$ are $X$-non-increasing. For the DPO diagram shown below,
        \begin{center}
        \begin{tikzpicture}
            % [node distance=15mm]
            \node (I) {$K$};
