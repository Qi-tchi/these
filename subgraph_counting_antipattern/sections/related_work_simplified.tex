% \newpage 
% ici \autoref{tab:antipattern:comparison:old}
% \begin{table}[H]
%    \centering
...
overbeek2024termination_lmcs} and Chapter~\ref{chap:subgraph_counting}, is summarized in~\autoref{tab:comparison:antipattern}. 
...
& Example 5 &  -- &  \ding{51} &   -- & -- & -- &  
          ...
          & \ding{51} & \ding{51} \\  
\Hline
    \Block{2-1}{\cite{bruggink2014termination}}& Example 1 
   & -- & -- & \ding{51} & -- & -- & 
                 --
               &  \ding{55} & \ding{51}\\ 
   \Hline
