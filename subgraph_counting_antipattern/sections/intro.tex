...
Consider the DPO rewriting system on edge-labeld directed multi-graphs shown in~\autoref{fig:intro:graph_transformation_rule_anti_pattern_}.
 \begin{figure}[!ht]
    \centering
\begin{tikzpicture}
...
This extension can handle systems (e.g.~\autoref{antipattern:ex:grs_aca} and~\autoref{antipattern:ex:endrullis:d3:termination}) which cannot be handled by the
