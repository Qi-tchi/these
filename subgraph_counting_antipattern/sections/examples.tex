...
\begin{example}
  ...
  Consider the rule $\rho$~\cite[Example 1]{bruggink2014termination}:
  \begin{center}
  \resizebox{\textwidth}{!}{ 
    \begin{tikzpicture}   
...
\begin{example}
    ...
    \begin{center}
        \resizebox{\textwidth}{!}{
    \begin{tikzpicture}  
       \graphbox{$L$}{0mm}{0mm}{32mm}{15mm}{2mm}{-8mm}{  
           \node[draw,circle]  (x) at (-6mm,0mm) {1};  
           \node[draw,circle]  (y) at (6mm,0mm) {};  
         }  
         \graphbox{$K$}{36mm}{0mm}{32mm}{15mm}{2mm}{-8mm}{  
           \node[draw,circle]  (x) at (-6mm,0mm) {1};  
         }  
         \graphbox{$R$}{72mm}{0mm}{32mm}{15mm}{1mm}{-8mm}{  
          \node[draw,circle]  (x) at (-6mm,0mm) {1};  
          \node[draw,circle]  (y) at (6mm,0mm) {};  
          \draw[->]  (x) to (y);  
         }   
        \node () at (34mm,-7mm) {$\leftarrowtail$};
        \node () at (70mm,-7mm) {$\rightarrowtail$}; 
   \end{tikzpicture}
    }
    \end{center}
