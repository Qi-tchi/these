...
%     \iota : X \mathop{\to} G \ |\ \nexists \zeta: X \mathop{\to} L.~\iota &= \zeta \mathop{\star} h_{LG} ~\land\\
%                         \nexists \eta: X \mathop{\to} C.~\iota &= \eta \mathop{\star} h_{CG} ~
%                 %         \land\\
%                 %  t_X &= \iota \mathop{\star} t_G 
%     ~\}
%     \\
%    \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'}) \overset{\operatorname*{def}}{=} \{ 
%     \iota: X \mathop{\to} H' \ |\ \nexists \zeta:X \mathop{\to} R_X.~\iota &= \zeta \mathop{\star} h_{R_XH'} \mathop{\land}              \\ \nexists \eta: X \mathop{\to} C.~\iota &= \eta \mathop{\star} h_{CH'}
%     %\\  t_X &= \iota \mathop{\star} t_{R_X}
%         ~\}
%     \\
%     \operatorname{Hom}(X, H, \lnot m'', \lnot r') \overset{\operatorname*{def}}{=} \{ 
%         \iota:X \mathop{\to} H \ |\ \nexists \zeta : X \mathop{\to} R.~\iota &= \zeta \mathop{\star} h_{RH} \land\\ \nexists \eta:X \mathop{\to} C.~\iota &= \eta \mathop{\star} h_{CH} 
%        % \mathop{\land}   \\ t_X &= \iota \mathop{\star} t_H
%             ~\}
% \end{flalign*}
...
%    By Definition~\ref{def:weight_excluding},
    ...
    % By Lemma~\ref{lem:2_exist} and Lemma~\ref{lem:2_distinct}, there exists an injective function $\mathbb{G} : \homset{X}{H} \mathop{\to} \homset{X}{H'}$. Therefore, $\mathbb{G}(\operatorname{Hom}(X, H, \lnot m'', \lnot r')) \mathop{\subseteq} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$. Thus, $|\operatorname{Hom}(X, H, \lnot m'', \lnot r')| \leq |\operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})|$.

    % By Lemma~\ref{lem:1_ex} and Lemma~\ref{lem:1_dist}, there exists an injective function $\mathbb{F} : \homset{X}{H'} \mathop{\to} \homset{X}{G}$. Therefore, $\mathbb{F}(\operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})) \mathop{\subseteq} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$. Hence, $|\operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})| \leq |\operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})|$.
...
%     If $b \mathop{\in} B \mathop{\setminus} \operatorname{Im}(h_{AB})$, then there is no $c \mathop{\in} C$ such that $h_{BD}(b) \mathop{=} h_{CD}(c)$.
% \end{lemma}
...
%     \begin{itemize}
%         \item \label{lem:b_c_same_img_exist_a:1} For all \(b \mathop{\in} B \mathop{\setminus} \operatorname{Im}(\alpha)\) and \(c \mathop{\in} C\), we have \(\beta'(b) \mathop{\neq} \alpha'(c)\).
%     \end{itemize}
    
% \end{lemma}

% \begin{proof}
%     Suppose, by contradiction, that there exist \(b \mathop{\in} B \mathop{\setminus} \operatorname{Im}(\alpha)\) and \(c \mathop{\in} C\) such that \(\beta'(b) \mathop{=} \alpha'(c)\). By Lemma~\ref{lem:b_c_same_img_exist_a}, there exists \(a \mathop{\in} A\) such that \(\alpha(a) \mathop{=} b\). This contradicts the assumption that \(b \notin \operatorname{Im}(\alpha)\) since \(\alpha(a) \mathop{=} b\) implies \(b \mathop{\in} \operatorname{Im}(\alpha)\).  
% \end{proof}
...
%     The homomorphism $h_{XH'}$ is the unique morphism such that $h_{C'X} \mathop{\star} h_{XH'} \mathop{=} h_{C'C} \mathop{\star} h_{CH'}$ and $h_{R'X} \mathop{\star} h_{XH'} \mathop{=} h_{R'R_X} \mathop{\star} h_{R_XH'}$.
% \end{lemma}
% \begin{proof}
%     We have $h_{C'C} \mathop{\star} h_{CH'} \mathop{=} h_{C'X} \mathop{\star} h_{XH'}$ and $h_{R'R_X} \mathop{\star} h_{R_XH'} \mathop{=} h_{R'X} \mathop{\star} h_{XH'}$ from the commutativity of $\square C'CH'X$ and $\square R'XH'R_X$. The uniqueness follows from the universal mapping property of the pushout $\square K'C'XR'$ and
%     \begin{flalign*}
%         h_{K'C'} \mathop{\star} h_{C'C} \mathop{\star} h_{CH'} & \mathop{=} h_{K'C'} \mathop{\star} h_{C'X} \mathop{\star} h_{XH'} & \text{by commutativity of $\square C'CH'X$}\\
%         & \mathop{=} h_{K'R'} \mathop{\star} h_{R'X} \mathop{\star} h_{XH'} & \text{by commutativity of $\square K'C'XR'$} \\
%         & \mathop{=} h_{K'R'} \mathop{\star} h_{R'R_X} \mathop{\star} h_{R_XH'} & \text{by commutativity of $\square R'XH'R_X$}
%     \end{flalign*}
%     \qed
% \end{proof}
...
%  Homomorphism $h_{XH'}$ is the unique morphism such that $h_{C'X} \mathop{\star} h_{XH'} \mathop{=} h_{C'C} \mathop{\star} h_{CH'}$ and $h_{R'X} \mathop{\star} h_{XH'} \mathop{=} h_{R'R_X} \mathop{\star} h_{R_XH'}$ 
% \end{lemma}
% \begin{proof}
%     we have $ h_{K'C'} \mathop{\star} h_{C'C} \mathop{\star} h_{CH'} \mathop{=} h_{K'R'} \mathop{\star} h_{R'R_X} \mathop{\star} h_{R_XH'} $ by Lemma~\ref{lem:dpo_dpo_unique_homo}. By the universal mapping property of the pushout $\square K'C'XR'$, we conclude.
%     \qed
% \end{proof}
...
\begin{lemma} 
    ...
    If $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$, then we have $\operatorname{Im}(h_{C'C})  \not \mathop{\subseteq} \operatorname{Im}(h_{KC})$ and $\operatorname{Im}(h_{R'R_X}) \not \mathop{\subseteq}  \operatorname{Im}(h_{KR_X}) $
\end{lemma}
\begin{proof}
    ...
    Suppose, by contradiction, that 
        \begin{flalign*}
            \operatorname{Im}(h_{C'C}) \mathop{\subseteq} \operatorname{Im}(h_{KC}) \tag{hyp1}\label{lem:nincl:hyp1}
...
\begin{flalign*}
    h_{C'K} \mathop{\star} h_{KC} \mathop{=} h_{C'C} \tag{0} \label{eq:h_cpk_star_h_kc_eq_h_cpc}
\end{flalign*}

The following equation follows:
\begin{flalign*}
    (h_{K'C'} \mathop{\star} h_{C'K} \mathop{\star} h_{KR_X}) \mathop{\star} h_{R_XH'} \mathop{=} (h_{K'R'} \mathop{\star} h_{R'R_X}) \mathop{\star} h_{R_XH'} \tag{1} \label{hrxhpm}
\end{flalign*}
because:
\begin{flalign*}
    & (h_{K'C'} \mathop{\star} h_{C'K} \mathop{\star} h_{KR_X}) \mathop{\star} h_{R_XH'} & \\
    \mathop{=} & h_{K'C'} \mathop{\star} h_{C'K} \mathop{\star} (h_{KR_X} \mathop{\star} h_{R_XH'}) & \text{by associativity} \\
    =& h_{K'C'} \mathop{\star} h_{C'K} \mathop{\star} (h_{KC} \mathop{\star} h_{CH'}) & \text{by commutativity of $\square KCH'R_X$} \\
    =& h_{K'C'} \mathop{\star} (h_{C'K} \mathop{\star} h_{KC}) \mathop{\star} h_{CH'} & \text{by associativity} \\
    =& h_{K'C'} \mathop{\star}  h_{C'C}  \mathop{\star} h_{CH'} & \text{by Equation~\eqref{eq:h_cpk_star_h_kc_eq_h_cpc}} \\
    =& h_{K'R'} \mathop{\star} h_{R'R_X}  \mathop{\star} h_{R_XH'} & \text{by commutativity of $K'C'CH'R_XR'$}\\
    =& (h_{K'R'} \mathop{\star} h_{R'R_X})  \mathop{\star} h_{R_XH'} & \text{by associativity}
\end{flalign*}

By Equation~\eqref{hrxhpm} and the monicity of \(h_{R_XH'}\), we deduce:
\begin{flalign*}
    h_{K'C'} \mathop{\star} h_{C'K} \mathop{\star} h_{KR_X} \mathop{=} h_{K'R'} \mathop{\star} h_{R'R_X} \tag{2} \label{hkpc_star_hcpk_star_hkrx}
\end{flalign*}
...
Thus, the commutative diagram depicted below holds:
    ...
    By Equation~\eqref{hkpc_star_hcpk_star_hkrx} and the universal mapping property of the pushout $\square K'C'XR'$, there exists a unique morphism $h_{XR_X}$ such that
        ...
        \begin{flalign*}
            h_{C'X} \mathop{\star} h_{XR_X} &= h_{C'K} \mathop{\star} h_{KR_X} \tag{3} \label{hcpx_star_hxrx}\\
            h_{R'X} \mathop{\star} h_{XR_X} &= h_{R'R_X} \tag{4} \label{hrpx_star_hxrx}
        \end{flalign*}   

    Subsequently, we have 
    \begin{flalign*}
        h_{C'X} \mathop{\star} (h_{XR_X} \mathop{\star}  h_{R_XH'}) &= h_{C'C} \mathop{\star}  h_{CH'} \tag{5} \label{eq5} \\
        h_{R'X} \mathop{\star} (h_{XR_X} \mathop{\star}  h_{R_XH'}) &=  h_{R'R_X} \mathop{\star}  h_{R_XH'} \tag{6} \label{eq6}
    \end{flalign*} because
    \begin{flalign*}
        & h_{C'X} \mathop{\star} (h_{XR_X} \mathop{\star}  h_{R_XH'})  &  \\
        \mathop{=} &( h_{C'X} \mathop{\star} h_{XR_X}) \mathop{\star}  h_{R_XH'}  & \text{by associativity}  \\
        \mathop{=}  & (h_{C'K} \mathop{\star} h_{KR_X}) \mathop{\star} h_{R_XH'}  & \text{by Equation~\eqref{hcpx_star_hxrx}}\\
        \mathop{=}  & h_{C'K} \mathop{\star} (h_{KR_X} \mathop{\star} h_{R_XH'})  & \text{by associativity}\\
        \mathop{=}  & h_{C'K} \mathop{\star} (h_{KC} \mathop{\star}  h_{CH'})  & \text{by commutativity of $\square KCH'R_X$}\\
        \mathop{=}  & (h_{C'K} \mathop{\star} h_{KC}) \mathop{\star}  h_{CH'}  & \text{by associativity}\\
        \mathop{=}  & h_{C'C} \mathop{\star}  h_{CH'}  & \text{by Equation~\eqref{eq:h_cpk_star_h_kc_eq_h_cpc}}\\
    \end{flalign*}
    and 
    \begin{flalign*}
        & h_{R'X} \mathop{\star} (h_{XR_X} \mathop{\star}  h_{R_XH'})    \\
        \mathop{=} &  (h_{R'X} \mathop{\star} h_{XR_X}) \mathop{\star}  h_{R_XH'} & \text{by associativity}  \\
        =&  h_{R'R_X} \mathop{\star}  h_{R_XH'}  & \text{by Equation~\eqref{hrpx_star_hxrx}}  \\
    \end{flalign*}

    Furthermore, by assumption, we have 
    \begin{flalign*}
        h_{C'X} \mathop{\star} h_{XH'} &= h_{C'C} \mathop{\star}  h_{CH'} \tag{7} \label{eq7} \\
        h_{R'X} \mathop{\star} h_{XH'} &=  h_{R'R_X} \mathop{\star}  h_{R_XH'} \tag{8} \label{eq8}
    \end{flalign*}
    ...
    % because under this assumption, there are no morphisms $h_{XR_X}$ satisfying $h_{XH'} \mathop{=} h_{XR_X} \mathop{\star} h_{R_XH'}$. Hence, $h_{C'C}(C') \not \mathop{\subseteq} h_{KC}(K)$ holds.
    \qed 
\end{proof}
...
\begin{lemma}
    ...
    If \(h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})\), then there exist 

    \textcolor{red}{supprimer : arrows \(c' \mathop{\in} C'\) and \(r' \mathop{\in} R'\) } 
...
\begin{proof}
    ...
    \begin{flalign*}
        h_{C'C}(c') \mathop{=} c \tag{-1} \label{cpc}
    \end{flalign*}
    ...
    \begin{itemize}
        ...
        \begin{flalign*}
            h_{K'C'}(k') \mathop{=} c' \tag{0} \label{kpcp}
        \end{flalign*}
         We therefore have:
        \begin{flalign*}
            &h_{CH'}(c) \mathop{=} h_{R_XH'}((h_{K'R'} \mathop{\star} h_{R'R_X})(k')) \tag{1} \label{eqimpossible}
        \end{flalign*}
        \noindent because 
        \begin{flalign*}
            =& h_{CH'}(h_{C'C}(c')) &\text{by Equation~\eqref{cpc}} \\
            =& h_{CH'}(h_{C'C}(h_{K'C'}(k'))) &\text{by Equation~\eqref{kpcp}} \\
            =& (h_{K'C'} \mathop{\star} h_{C'C} \mathop{\star} h_{CH'})(k') & \text{by definition of composition} \\
            =& (h_{K'R'} \mathop{\star} h_{R'R_X} \mathop{\star} h_{R_XH'})(k') &\text{by commutativity of $K'C'CH'R_XR'$} \\
            =& h_{R_XH'}((h_{K'R'} \mathop{\star} h_{R'R_X})(k')) & \text{by definition of composition}
        \end{flalign*}
        ...
        %  and \( h_{KR_X}(k) \mathop{=} (h_{K'R'} \mathop{\star} h_{R'R_X})(k') \) hold
    ...
    \end{claim}
    \begin{itemize}
        \item Suppose, by contradiction, that \( \operatorname{Im}(h_{K'C'}) \mathop{=} \emptyset \). We have \( K' \mathop{=} \emptyset \). Since \( X \) is connected\todo{X connectivity} and \( \square K'C'XR' \) is a pushout square, we have \( C' \mathop{=} \emptyset \) or \( R' \mathop{=} \emptyset \); otherwise, \( X \) could not be connected. By symmetry, we suppose \( C' \mathop{=} \emptyset \).

        Consequently, the monomorphism \( h_{R'X} \) is also an isomorphism. Let \( h_{XR'}: X \mathop{\to} R' \) be an inverse to \( h_{R'X} \). We have:
        \begin{flalign*}
            & h_{XH'} \\
            \mathop{=} & \operatorname{id}_X \mathop{\star} h_{XH'} \\
            \mathop{=} &(h_{XR'} \mathop{\star} h_{R'X}) \mathop{\star} h_{XH'} & \text{because $\operatorname{id}_X \mathop{=} h_{XR'} \mathop{\star} h_{R'X}$} \\
            \mathop{=} &h_{XR'} \mathop{\star} (h_{R'X} \mathop{\star} h_{XH'}) & \text{by commutativity of $R'XH'R_X$} \\
            \mathop{=} &h_{XR'} \mathop{\star} (h_{R'R_X} \mathop{\star} h_{R_XH'}) & \text{by associativity} \\
...
\begin{lemma}
    ...
    Consider the commutative diagram, depicted below, where $h_{XH'} \mathop{\in} \Psi_{\lnot R_X,\lnot C}$:
...
\end{lemma}
\begin{proof}
    % Suppose $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$.
    ...
    From Equation~\eqref{m1} and \todo{to debug !!! removed : condidion for all $a \mathop{\in} R_X$, we have $h_{R_XL}(a) \mathop{\in} \operatorname{Im}(h_{KL})$ if and only if $a \mathop{\in} \operatorname{Im}(h_{KR_X})$ in the definition of $R_X$} \textcolor{red}{the edge-injectivity} \textcolor{blue}{$h_{R_XL}$ do not identify interface nodes with non-interface nodes} , we have 
    \begin{flalign*}
    ...
    % \begin{flalign*}
    %              (h_{R'R_X} \mathop{\star} h_{R_XL}) (r')
    %         \mathop{=}  & h_{R_XL} (h_{R'R_X}(r')) \\
    %     \notin & h_{R_XL}(h_{KR_X}(K)) \\
    %         \mathop{=}  & (h_{KR_X} \mathop{\star} h_{R_XL})(K) \\
    %         \mathop{=}  & h_{KL}(K) \\
    %         \mathop{=}  & \operatorname{Im}(h_{KL})
    % \end{flalign*}
    ...
    Suppose that there exists a morphism $h_{XC}: X \mathop{\to} C$ such that 
        \begin{flalign*}
            h_{XH'} \mathop{\star} h_{H'G} \mathop{=} h_{XC} \mathop{\star} h_{CG} \tag{2} \label{hyp:xhpgc}
        \end{flalign*}
...
\end{center}
    ...
    \begin{flalign*}
        ...
        &= (h_{R'R_X} \mathop{\star} (h_{R_XL} \mathop{\star} h_{LG}))(r') & \text{by associativity} \\
        &= (h_{R'R_X} \mathop{\star} (h_{R_XH'} \mathop{\star} h_{H'G}))(r') & \text{by commutativity of $\square R_XH'GL$} \\
        &= ((h_{R'R_X} \mathop{\star} h_{R_XH'}) \mathop{\star} h_{H'G})(r') & \text{by associativity} \\
        &= ((h_{R'X} \mathop{\star} h_{XH'}) \mathop{\star} h_{H'G})(r') & \text{by commutativity of $\square R'XH'R_X$} \\
        &= (h_{R'X} \mathop{\star} (h_{XH'} \mathop{\star} h_{H'G}))(r') & \text{by associativity} \\
        &= (h_{R'X} \mathop{\star} (h_{XC} \mathop{\star} h_{CG}))(r') & \text{by Equation~\eqref{hyp:xhpgc}} \\
        &= (h_{R'X} \mathop{\star} h_{XC} \mathop{\star} h_{CG})(r') & \text{by associativity} \\
    ...
    \begin{flalign*}
        h_{XH'} \mathop{\star} h_{H'G} \mathop{=} h_{XL} \mathop{\star} h_{LG} \tag{3} \label{hyp:xhpgl}
    \end{flalign*}
    ...
    \end{center}
        ...
        \begin{flalign*}
            ...
            =& (h_{C'C} \mathop{\star} (h_{CH'} \mathop{\star} h_{H'G}))(c') & \text{by commutativity of $\triangle CGH'$} \\
            =& ((h_{C'C} \mathop{\star} h_{CH'}) \mathop{\star} h_{H'G})(c') & \text{by associativity} \\
            =& ((h_{C'X} \mathop{\star} h_{XH'}) \mathop{\star} h_{H'G})(c') & \text{by commutativity of $\square C'CH'X$} \\
            =& (h_{C'X} \mathop{\star} (h_{XH'} \mathop{\star} h_{H'G}))(c') & \text{by associativity} \\
            =& (h_{C'X} \mathop{\star} (h_{XL} \mathop{\star} h_{LG}))(c') & \text{by Equation~\eqref{hyp:xhpgl}} \\
            =& (h_{C'X} \mathop{\star} h_{XL} \mathop{\star} h_{LG})(c') & \text{by associativity} \\
...
\end{lemma}
\begin{proof}
    Let $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$. We can construct the commutative diagram depicted below:
    ...
    There are arrows $c' \mathop{\in} C'$ and $r' \mathop{\in} R'$ such that 
    $h_{C'C}(c') \notin h_{KC}(K)$ and $h_{R'R_X}(r') \notin h_{KR_X}(K)$, by Lemma~\ref{lem:cp_in_mcp_and_rp_in_mrp}\todo{lemma 38 only used in lemma 40}.

    Let $h_{H'G}$ be the unique homomorphism such that \(h_{CH'} \mathop{\star} h_{H'G} \mathop{=} h_{CG}\) and \(h_{R_XH'} \mathop{\star} h_{H'G} \mathop{=} h_{R_XL} \mathop{\star} h_{LG}\), assumed by the universal mapping property of the pushout square $\square KCH'R_X$.
        
    We have $h_{XH'} \mathop{\star} h_{H'G} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$ by Lemma~\ref{lem:hxhp_star_hhpg_in_psi_u_lnotl_lnotc}\todo{ici, we do not need c' and r' be arrows}.
...
%     % \item Morphism $h_{XH'}$ is the unique morphism such that $h_{C'X}\star h_{XH'} \mathop{=} h_{C'C}\star h_{CH'}$ and $h_{R'X}\star h_{XH'} \mathop{=} h_{R'R_X}\star h_{R_XH'}$
%     % \item Morphism $h_{H'G}$ is the unique morphism such that $h_{CH'}\star h_{H'G} \mathop{=} h_{CG}$ and $h_{R_XH'}\star h_{H'G} \mathop{=} h_{R_XL}\star h_{LG}$
% \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{flalign*}
                h_{H'G}(h_1)&= h_{H'G}(h_{CH'}(c_1)) & \text{by definition of $h_1$}\\
                            ...
                            &\mathop{\neq} h_{CG}(c_2) & \text{by monicity of $h_{CG}$ and $c_1 \mathop{\neq} c_2$} \\
                            &= (h_{CH'} \mathop{\star} h_{H'G})(c_2) & \text{by commutativity of $\triangle CGH'$} \\
                            &= h_{H'G}(h_{CH'}(c_2)) \\
            ...
            \begin{flalign*}
                h_{H'G}(h_1) &= h_{H'G}(h_{R_XH'}(r_1)) & \text{by definition of $h_1$}\\
                             ...
                             &= (h_{R_XL} \mathop{\star} h_{LG})(r_1) & \text{by commutativity of $\square R_XH'GL$} \\
                             &\mathop{\neq} (h_{R_XL} \mathop{\star} h_{LG})(r_2) & \text{because $h_{R_XL} \mathop{\star} h_{LG}$ is injective on arrows and $r_1 \mathop{\neq} r_2$} \\
                             &= (h_{R_XH'} \mathop{\star} h_{H'G})(r_2) & \text{by commutativity of $\square R_XH'GL$} \\
                             &= h_{H'G}(h_{R_XH'}(r_2)) \\
                             &= h_{H'G}(h_2) & \text{by definition of $h_2$}
            \end{flalign*}
                    ...
                    \item[(3.1)] If $c \notin \operatorname{Im}(h_{KC})$ then 
                        \begin{flalign*}
                            h_{H'G}(h_1) &= h_{H'G}(h_{CH'}(c)) & \text{by definition of $h_1$}\\
                                         ...
                                         &\mathop{\neq} h_{LG}(h_{R_XL}(r)) & \text{by Lemma~\ref{lem:b_c_same_img_exist_a} and $c\notin \operatorname{Im}(h_{KC})$} \\
                                         &= (h_{R_XL} \mathop{\star} h_{LG})(r) \\
                                         &= (h_{R_XH'} \mathop{\star} h_{H'G})(r) & \text{by commutativity of $\square R_XH'GL$} \\
                                         &= h_{H'G}(h_{R_XH'}(r))\\
                                         &= h_{H'G}(h_2) & \text{by definition of $h_2$}
                        \end{flalign*}
                    \item[(3.2)] Suppose that $r \notin \operatorname{Im}(h_{KR_X})$. Then $h_{R_XL}(r) \notin \operatorname{Im}(h_{KL}) \mathop{=} \operatorname{Im}(h_{KR_X} \mathop{\star} h_{R_XL})$ by the commutativity of $\triangle KR_XL$. Therefore, 
                        \begin{flalign*}
                            h_{H'G}(h_1) &= h_{H'G}(h_{CH'}(c))  & \text{by definition of $h_1$} \\
                                         &= (h_{CH'} \mathop{\star} h_{H'G})(c) \\
                                         &= h_{CG}(c) & \text{by commutativity of $\triangle CGH'$} \\
                                         &\mathop{\neq} h_{LG}(h_{R_XL}(r)) & \text{by Lemma~\ref{lem:b_c_same_img_exist_a} and $h_{R_XL}(r) \notin \operatorname{Im}(h_{KL})$ } \\
                                         &= (h_{R_XL} \mathop{\star} h_{LG})(r) \\
                                         &= (h_{R_XH'} \mathop{\star} h_{H'G})(r) & \text{by commutativity of $\square R_XH'GL$} \\
                                         &= h_{H'G}(h_{R_XH'}(r))\\
                                         &= h_{H'G}(h_2) & \text{by definition of $h_2$}
                    ...
                    \item[(3.3)] Otherwise, there are $k_1, k_2 \mathop{\in} K$ such that $h_{KC}(k_1) \mathop{=} c$ and $h_{KR_X}(k_2) \mathop{=} r$. We have $k_1 \mathop{\neq} k_2$ because if $k_1 \mathop{=} k_2$, then we would have a contradiction:
                        \begin{flalign*}
                            h_1 &= h_{CH'}(c)  & \text{by definition of $h_1$}\\
                                ...
                                &= h_{CH'}(h_{KC}(k_2)) &\text{by $k_1 \mathop{=} b_2$} \\
                        ...
                        \begin{flalign*}
                            h_{H'G}(h_1) &= h_{H'G}(h_{CH'}(c)) & \text{by definition of $h_1$} \\
                                        ...
                                        %  &= (h_{CH'} \mathop{\star} h_{H'G})(c)   \\
                                         ...
                                         &= (h_{KC} \mathop{\star} (h_{CH'} \mathop{\star} h_{H'G}))(k_1) &\text{by associativity} \\
                                         &= (h_{KC} \mathop{\star} h_{CG})(k_1) & \text{by commutativity of $\triangle CGH'$} \\
                                         &\mathop{\neq} (h_{KC} \mathop{\star} h_{CG})(k_2) & \text{by monicity of $h_{KC} \mathop{\star} h_{CG}$ and $k_1 \mathop{\neq} k_2$} \\
                                         &= (h_{KL} \mathop{\star} h_{LG})(k_2) & \text{by commutativity of $\square KCGL$} \\
                                         &= (h_{KR_X} \mathop{\star} h_{R_XL} \mathop{\star} h_{LG})(k_2) & \text{by commutativity of $\triangle KR_XL$} \\
                                         &= (h_{KR_X} \mathop{\star} (h_{R_XL} \mathop{\star} h_{LG}))(k_2) & \text{by associativity} \\
                                         &= (h_{KR_X} \mathop{\star} (h_{R_XH'} \mathop{\star} h_{H'G}))(k_2) & \text{by commutativity of $\square R_XH'GL$} \\
                                         &= (h_{R_XH'} \mathop{\star} h_{H'G})(r) & \text{by definition of $r$} \\
                                         &= h_{H'G}(h_{R_XH'}(r))\\
                                         &= h_{H'G}(h_2) & \text{by definition of $h_2$}
                        \end{flalign*}
                \end{itemize}            
...
%     Let $f, g : X \mathop{\rightarrow} Y$ be two graph homomorphisms. Since $X$ is connected, if $f \mathop{\neq} g$, then there is an arrow $e \mathop{\in} X$ such that $f(e) \mathop{\neq} g(e)$. 
% \end{lemma}

% \begin{proof}
%     The graph $X$ is not an empty graph, since it \todo{X} has at least one arrow by assumption. From $f \mathop{\neq} g$, there exists $x \mathop{\in} X$ such that $f(x) \mathop{\neq} g(x)$. If $x$ is an arrow, then the property holds. Suppose that $x$ is a node. Since \todo{X} $X$ is connected by assumption, the node $x$ has at least one incident arrow $e$, and we have $f(e) \mathop{\neq} g(e)$.
% \end{proof}
...
\begin{lemma}
   \label{lem:exist_hxhp} 
    ...
    There is a homomorphism $h_{XH'}$ satisfying $h_{XH'} \mathop{\star} h_{H'H} \mathop{=} h_{XH}$.
...
\begin{proof}
    ...
    From the commutativity of the diagram, we have 
        \begin{flalign*}
            h_{K'C'} \mathop{\star} h_{C'C} \mathop{\star} h_{CH'} \mathop{=} h_{K'R'} \mathop{\star} h_{R'R_X} \mathop{\star} h_{R_XH'}
        \end{flalign*}
    Hence, by the universal mapping property of the pushout $\square K'C'XR'$, there is a unique graph homomorphism $h_{XH'}$ such that
        \begin{flalign*}
            h_{R'X} \mathop{\star} h_{XH'} &= h_{R'R_X} \mathop{\star} h_{R_XH'} \tag{1} \label{eq:rpxhprx}\\
    ...
    \begin{center}
        ...
        \begin{flalign*}
            ...
            &= (h_{R'R_X} \mathop{\star} h_{R_XR}) \mathop{\star} h_{RH} &\text{by commutativity of $\triangle R'R_XR$} \\
            &= h_{R'R_X} \mathop{\star} (h_{R_XR} \mathop{\star} h_{RH}) & \text{by associativity}\\
            &= h_{R'R_X} \mathop{\star} (h_{R_XH'} \mathop{\star} h_{H'H}) &\text{by commutativity of $\square R_XH'HR$}\\
            &= (h_{R'R_X} \mathop{\star} h_{R_XH'}) \mathop{\star} h_{H'H} &\text{by associativity}\\
            &= (h_{R'X} \mathop{\star} h_{XH'}) \mathop{\star} h_{H'H} &\text{by Equation~\eqref{eq:rpxhprx}}\\
            &= h_{R'X} \mathop{\star} (h_{XH'} \mathop{\star} h_{H'H}) &\text{by associativity}\\
        \end{flalign*}
        and
        \begin{flalign*}
            h_{C'C} \mathop{\star} h_{CH}
            &= h_{C'C} \mathop{\star} (h_{CH'} \mathop{\star} h_{H'H}) & \text{by commutativity of $\triangle CH'H$} \\
            &= (h_{C'C} \mathop{\star} h_{CH'}) \mathop{\star} h_{H'H} & \text{by associativity} \\
            &= (h_{C'X} \mathop{\star} h_{XH'}) \mathop{\star} h_{H'H} & \text{by commutativity of $\square C'CH'X$} \\
            &= h_{C'X} \mathop{\star} (h_{XH'} \mathop{\star} h_{H'H}) & \text{by associativity}
        \end{flalign*}
...
\begin{lemma}
    ...
    If $h_{XH} \mathop{\in} \operatorname{Hom}(X, H, \lnot m'', \lnot r')$ then $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$.
...
\begin{flalign*}
    \not \exists h_{XC}. h_{XH} \mathop{=} h_{XC} \mathop{\star} h_{CH} \tag{1} \label{hyp:not_fac_through_c}\\
    \not \exists h_{XR}. h_{XH} \mathop{=} h_{XR} \mathop{\star} h_{RH} \tag{2} \label{hyp:not_fac_through_r}
\end{flalign*}
...
\begin{itemize}
    ...
    \begin{flalign*}
        h_{XC} \mathop{\star} h_{CH'} \mathop{=} h_{XH'}\tag{3} \label{hyp:xchp}
    \end{flalign*}

    Under this assumption, we have:
    \begin{flalign*}
        h_{XC} \mathop{\star} h_{CH} 
        &= h_{XC} \mathop{\star} (h_{CH'} \mathop{\star} h_{H'H}) & \text{by commutativity of $\triangle CHH'$} \\
        &= (h_{XC} \mathop{\star} h_{CH'}) \mathop{\star} h_{H'H} & \text{by associativity} \\
        &= h_{XH'} \mathop{\star} h_{H'H} & \text{by Equation~\eqref{hyp:xchp}} \\
...
\begin{itemize}
    ...
    \begin{flalign*}
        h_{XR_X} \mathop{\star} h_{R_XH'} \mathop{=} h_{XH'} \tag{4} \label{hyp:xrxhp}
    \end{flalign*}

    Let $h_{XR} \overset{\operatorname{def}}{=} h_{XR_X} \mathop{\star} h_{R_XR}$. Under this assumption, we have:
    \begin{flalign*}
        h_{XR} \mathop{\star} h_{RH} &= (h_{XR_X} \mathop{\star} h_{R_XR}) \mathop{\star} h_{RH} & \text{by definition of $h_{XR}$} \\
                            &= h_{XR_X} \mathop{\star} (h_{R_XR} \mathop{\star} h_{RH}) & \text{by associativity} \\
                            &= h_{XR_X} \mathop{\star} (h_{R_XH'} \mathop{\star} h_{H'H}) & \text{by commutativity of $\square R_XH'HR$} \\
                            &= (h_{XR_X} \mathop{\star} h_{R_XH'}) \mathop{\star} h_{H'H} & \text{by associativity} \\
                            &= h_{XH'} \mathop{\star} h_{H'H} & \text{by Equation~\eqref{hyp:xrxhp}} \\
                            &= h_{XH} & \text{by commutativity of $\triangle XHH'$}
    \end{flalign*}
...
\begin{proof}
    ...
    By Proposition~\ref{prop:pb_eq_po}, the pushout square $\square KCHR$ is also a pullback square. Consequently, there exists a morphism from $K'$ to $K$, making the following commutative diagram hold:
        ...
        \item We show first that $h_{R'X}$ is not an isomorphism. Suppose, by contradiction, that $h_{R'X}$ is an isomorphism with an inverse $h_{R'X}^{-1}$. We have 
            \begin{flalign*}
                h_{XH} 
                       ...
                       &= h_{R'X}^{-1} \mathop{\star} (h_{R'X} \mathop{\star} h_{XH}) &\text{by associativity} \\
                       &= h_{R'X}^{-1} \mathop{\star} (h_{R'R} \mathop{\star} h_{RH}) &\text{by commutativity of $\square R'XHR$} \\
                       &= (h_{R'X}^{-1} \mathop{\star} h_{R'R}) \mathop{\star} h_{RH} &\text{by associativity}
            \end{flalign*}
    ...
    We conclude that $h_{XH'} \mathop{\in} \operatorname{Hom}(X, H', \lnot h_{R_XH'}, \lnot h_{CH'})$ by Lemma~\ref{lem:ifin_psi_lnot_r_lnot_c_thenin_psi_lnot_rx_lnot_c}.
