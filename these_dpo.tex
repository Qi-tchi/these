...
% Extending the morphism counting technique to count subgraphs that are not included in specific subgraphs is another interesting direction, which allows the technique to handle~\autoref{rem:d3_limitation}.
