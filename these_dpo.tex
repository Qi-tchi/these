...
Extending the subgraph counting technique to counting subgraph that does not include in a specific subgraph is another interesting direction. This could lead to a more powerful termination criterion that can handle more complex graph rewriting systems.
...
It is also worth investigating the difference of our subgraph counting technique with
 the technique based on the same idea and with the same name developed for PBPO+ graph rewriting systems proposed by Overbeek and Endrullis.
