...
The implementation of the modular termination technique~\cite{plump18plump2018modular} which complements the type graph method and the subgraph counting technique, could be another interesting but more practical direction. This could lead to a more powerful termination tool.
