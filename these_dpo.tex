...
% % \newpage 
% % \section{Appendix}
% % \input{type_graph/sections/appendix.tex}
% % \subsection{Graphs}
...
% % \input{sections/category_my_composition_notation.tex}
% % \input{sections/monomorphism.tex}
% % \input{sections/span.tex}
% % \input{sections/cospan.tex}
% % \input{sections/commutative_diagram.tex}
% % \input{sections/pushout.tex}
% % \input{sections/notation_morphism.tex}
% % \else
% % \fi  
