...
% The concepts and notation in~\autoref{Preliminaries:Graphs} and~\autoref{Preliminaries:Pushout} follow the treatments in~\cite{pierce1991basic,barr1990category}; the presentation in~\autoref{sec:dpo} is based on~\cite{endrullis2024generalized_icgt}.
...
% The implementation of the type graph method and our extension, along with our morphism counting technique and its extension, was integrated into a unified tool, called LyonParallel~\footnote{LyonParallel is available at \url{https://github.com/Qi-tchi/LyonParallel/tree/thesis}}.
