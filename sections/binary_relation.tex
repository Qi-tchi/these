We define binary relations on collections of objects instead of on sets. A collection is not necessarily a set. A well known example is that the collection of all sets is not a set.
\begin{notation}
