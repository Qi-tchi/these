...
\begin{definition}[Sequential independence]
    \todo{rewrite}
   Direct derivations $G \mathop{\Rightarrow}_{r_1} H \mathop{\Rightarrow}_{r_2} M$ as in Figure 4 are sequentially independent if there are morphisms $R_1 \mathop{\to} D_2$ and $L_2 \mathop{\to} D_1$ such that the following holds.
    \begin{itemize}
        \item Commutativity: $R_1 \mathop{\to} D_2 \mathop{\to} H \mathop{=} R_1 \mathop{\to} H$ and $L_2 \mathop{\to} D_1 \mathop{\to} H \mathop{=} L_2 \mathop{\to} H$.
        \item Injectivity: $R_1 \mathop{\to} D_2 \mathop{\to} M$ is injective.
    \end{itemize}
...
\begin{definition}[Sequential critical pair]
    Let $r_i \mathop{\colon} \langle L_i \mathop{\leftarrow} K_i \mathop{\rightarrow} R_i \rangle$ be rules, for $i \mathop{=} 1, 2$. A pair of direct derivations $G \mathop{\Rightarrow}_{r_1} H \mathop{\Rightarrow}_{r_2} M$ as depicted below is a sequential critical pair if the following holds.
    \begin{itemize}
        \item Minimality:$H \mathop{=} h_1(R_1) \mathop{\cup} g_2(L_2)$.
...
\begin{theorem}
    \todo{rewrite}
    Let $\langle \Sigma, \mathcal{R} \rangle$ and $\langle \Sigma, \mathcal{S} \rangle$ be terminating hypergraph transformation systems. If there are no sequential critical pairs of shape $S \mathop{\Rightarrow}_{\mathcal{R}} T \mathop{\Rightarrow}_{\mathcal{S}} U$, then the combined system $\langle \Sigma, \mathcal{R} \mathop{\cup} \mathcal{S} \rangle$ is terminating.
\end{theorem}
