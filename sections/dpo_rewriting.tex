...
The diagram with double pushout in Definition~\ref{def:rewriting_step} is said to be a \textbf{witness}\index{Witness!of DPO rewriting step} for the \textbf{rewriting step}\index{DPO rewriting step} from \( G \) to \( H \) using
