...
\begin{definition} 
  \label{def:rewriting_step}
    ...
    %  in~\autoref{fig:preliminaries:a_rewriting_step_slkjdfsljsdl} 
...
In category \textbf{Graph}, the pushout of two arrows always exists by~\autoref{prop:pushout_graph_always_exists}. Therefore, consider the DPO diagram shown
below.
%   in~\autoref{fig:preliminaries:a_gadsfsddfsmework}. 
...
%  in~\autoref{fig:preliminaries:a_rewrdfagiting_rule_sfdsgdfa}.
% \begin{figure}[H]
%       \centering
\begin{center}
      \resizebox{0.7\textwidth}{!}{
...
below.
%  in Figure~\autoref{fig:preliminaries:a_match_dangling_edge_condition}. 
