...
As an example, 
consider the graph transformation rule, shown in the following~\autoref{fig:intro:graph_transformation_rule_dpo_sssssfggaaadww}.
  \begin{figure}[H]
    \centering
% \begin{center} 
    \resizebox{0.85\textwidth}{!}{
