...
%  In this sense, we are in the oposite side of~\cite{overbeek2024termination_lmcs,overbeekthesis} which develop general method applicable to different DPO graph rewriting systems.
...
The extension successfully proves termination for systems like the ones presented 
