...
\begin{example}
  ...
  \begin{figure}[H]
    ...
    \end{figure}
   Let $c$ be the morphism shown in~\autoref{fig:nwf:context_closure_grsaa}. Since for every match $m : L \to G$, there is a morphism $\alpha : G \to T$ such that $m \star \alpha = c$, the morphism $c$ is a context closure for the DPO rule in the type graph.
  \begin{figure}[H]
    \centering
...
\begin{example}
  ...
  \begin{figure}[H]
    ...
    \end{figure}
     There are 4 morphisms $t_K^{11}, t_K^{12}, t_K^{21}, t_K^{22}$ from $K$ to $T$ shown in~\autoref{fig:nwf:grsaa_rule_morphisms}.
    ...
    \begin{figure}[H]
      ...
      \end{figure}
    The set $\{l \star - = t_K^{11}\}$ has two morphisms $h_{11}^1$ and $h_{11}^2$ shown in~\autoref{fig:nwf:grsaa_rule_morphisms_22}.
    \begin{figure}[H]
        \centering
        \resizebox{0.6\textwidth}{!}{
        \begin{tikzpicture}
    ...
    There is a context closure $c$ for the DPO rule in the weighted type graph, as shown in \autoref{wf:example:context_closure}.
