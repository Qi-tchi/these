...
\end{minipage}
    \begin{enumerate}[label=(\alph*)]
        \item\label{traceable:a} there exists a morphism $f : X \mathop{\to} B$ such that $h \mathop{=} f \mathop{\star} \beta'$, or
        \item\label{traceable:b} there exists a morphism $g : X \mathop{\to} C$ such that $h \mathop{=} g \mathop{\star} \alpha'$.
    \end{enumerate}
    If additionally, 
    ...
    \begin{enumerate}[label=(\alph*),resume]
        \item 
        there exists a morphism $k : X \mathop{\to} A$ such that $h \mathop{=} k \mathop{\star} \alpha \mathop{\star} \beta' $,
    \end{enumerate}
