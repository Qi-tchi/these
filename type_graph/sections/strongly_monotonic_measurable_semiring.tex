...
\begin{definition} 
    ...
    such that $0 \neq 1$ and for all $x,y,z,w \in S$, for all $\delta \in \mathbb{R}$ and $\delta>0$, we have
        \begin{align*}
            ...
            &\tag{S5} \label{ax:s4}
            \\ 
            \delta + \mu(x) <_{\overline{\mathbb{R}}} \mu(y) \land 1 \preceq z \land z \neq 0
            &\Rightarrow
...
\begin{example}
    ...
    The real arctic semiring $$\mathfrak{A}' \isdef (\mathbb{R} \cup \{-\infty\},\operatorname{max}_{\mathbb{R} \cup \{-\infty\}}, +_{\mathbb{R} \cup \{-\infty\}}, 
    \\
    ...
    \begin{flalign*}
        ...
        \mu & \longmapsto \operatorname{id}_{\mathbb{R} \cup \{-\infty\}}.
    \end{flalign*}
    It is a strongly monotonic measurable semiring but not strictly monotonic measurable, because we have $2 <_{\mathbb{R} \cup \{-\infty\}} 3$ but $$2 \oplus 3 \isdef \operatorname{\max}_{\mathbb{R} \cup \{-\infty\}}(2,3) = 3 \not <_{\mathbb{R} \cup \{-\infty\}} 3 = \operatorname{\max}_{\mathbb{R} \cup \{-\infty\}}(3,3) \isdef 3 \oplus 3.$$
...
\begin{example} 
    ...
    The natural tropical semiring $$\mathfrak{T} \isdef (\mathbb{N} \cup \{+\infty\},\operatorname{min}_\mathbb{N},+_{\mathbb{N}},+\infty, 0_\mathbb{N}, <_{\mathbb{N}} , \operatorname{id}_{\mathbb{N} \cup \{+\infty\}})$$ is an instance of the strongly monotonic measurable semiring where
    \begin{flalign*}
    ...
    \end{flalign*}
    The natural arctic semiring $$\mathfrak{A} \isdef (\mathbb{N} \cup \{-\infty\},\operatorname{max}_\mathbb{N},+_{\mathbb{N}},-\infty, 0_\mathbb{N},<_{\mathbb{N}}, \operatorname{id}_{\mathbb{N} \cup \{-\infty\}})$$ is an instance of the strongly monotonic measurable semiring where
    \begin{flalign*}
        S & \longmapsto \mathbb{N} \cup \{-\infty\},
        \\
