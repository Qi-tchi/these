...
\begin{example}
    Consider the following morphisms, illustrated using the visual notation introduced in \autoref{notation:graph_homomorphism}, and the weighted type graph $\mathcal{T}$ from \autoref{wf:example:weighted_type_graph}:
    \begin{center}
