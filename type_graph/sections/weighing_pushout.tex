...
\begin{definition} 
    ...
    The \textbf{measurement of a morphism \( h:G \mathop{\to} T \) relative to a morphism-ruler \( e: X \mathop{\to} T \), excluding morphisms in \( \Gamma' \)}\index{Measurement of a morphism!of the type graph method}, denoted by $m_e(h-\Gamma)$, is defined as:
    \[
...
\end{center}
  one of the following conditions holds:
    ...
    \end{enumerate}
    then we say that $X$ is \textbf{strongly traceable}\index{strongly traceable} along $\Delta$.
\end{definition}
