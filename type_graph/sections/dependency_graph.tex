In the appendices of Chapter~\ref{chap:subgraph_counting} and Chapter~\ref{chap:antipattern}, and~\textsection~\autoref{antipattern:sec:termination_criterion}, we present some propositions, lemmas, and theorems.
