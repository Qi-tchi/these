...
The dependency structure among these results is clarified in~\autoref{fig:dependency_graph}, in which black nodes correspond to results in Chapter~\ref{chap:subgraph_counting} while red nodes correspond to results in Chapter~\ref{chap:antipattern}.
\begin{figure}[H]
