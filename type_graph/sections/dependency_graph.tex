...
in which black nodes correspond to results in Chapter~\ref{chap:subgraph_counting} while red nodes correspond to results in Chapter~\ref{chap:antipattern}.
...
\begin{tikzpicture}
  ...
  \node[draw] (lem_xinXcpinCrpinR) at (9,12) {Lem.$\ref{lem:xinXcpinCrpinR}$};
   ...
   \node[draw] (lem_h_hp_diff_g_gp_diff) at (2,6) {Lem.$\ref{lem:h_hp_diff_g_gp_diff}$};
    ...
    \node[draw] (subgraph_counting_lem_w_g_geq_w_h_leq) at (0,2) {\textbf{Lem.}$\ref{subgraph_counting:lem:w_g_geq_w_h_leq}$};
    ...
    \node[draw](subgraph_counting_thm_termination_grs) at (0,0) {\textbf{Thm.}$\ref{subgraph_counting:thm:termination_grs}$};
    ...
    \node[draw,red] (antipattern_lem_xgm_xhmp_xl_xr) at (9, -2) {Lem.$\ref{antipattern:lem:xgm_xhmp_xl_xr}$};
        ...
        \node[draw,red] (antipattern_lem_w_g_geq_w_h_leq) at (3,-3) {\textbf{Lem.}$\ref{antipattern:lem:w_g_geq_w_h_leq}$};
        ...
        \node[draw,red] (antipattern_thm_termination_grs) at (3,-4) {\textbf{Thm.}$\ref{antipattern:thm:termination_grs}$};
