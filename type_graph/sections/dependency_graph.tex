...
\begin{tikzpicture}
  ...
  \node[draw] (lem_xinXcpinCrpinR) at (9,12) {Lem.$\ref{lem:xinXcpinCrpinR}$};
    ...
    \node[draw] (kpcpxrp_po) at (10,10) {Lem.$\ref{kpcpxrp_po}$};
    
        \node[draw,blue] (antipattern_lem_xh_decomp) at (11,8) {Lem.$\ref{antipattern:lem:xh_decomp}$};

    \node[draw] (subgraph_counting_lem_decomp_w_u) at (0,6) {Lem.$\ref{subgraph_counting:lem:decomp_w_u}$};
    \node[draw] (lem_h_hp_diff_g_gp_diff) at (2.5,6) {Lem.$\ref{lem:h_hp_diff_g_gp_diff}$};
    ...
    \node[draw] (subgraph_counting_lem_w_u_l_not_geq_r_not) at (9,4) {Lem.$\ref{subgraph_counting:lem:w_u_l_not_geq_r_not}$};
