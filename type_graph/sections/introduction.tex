This chapter extends the weighted type graph method to non-well-founded semirings, which allows for more efficient searching for weighted type graphs that witness relative termination of DPO rewriting systems on edge-labeled directed multigraphs.
