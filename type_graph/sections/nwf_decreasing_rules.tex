...
\begin{definition} 
    ...
    \noindent
    The rule $\rho$ is said to be \textbf{$\delta$-uniformly decreasing}\index{$\delta$-uniformly decreasing} with respect to $\mathcal{T}$ in $\mathfrak{F}$ if the following conditions hold:
        \begin{itemize}
    ...
    The rule $\rho$ is said to be
            \textbf{$\delta$-closure decreasing}\index{$\delta$-closure decreasing} with respect to $\mathcal{T}$ in $\mathfrak{F}$ if the following conditions hold:
            \begin{itemize}
