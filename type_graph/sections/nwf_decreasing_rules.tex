  ...
  By Lemma~\ref{nwf:lem_4d13}, we have 
    ...
    \begin{enumerate}
        ...
        \item
            ...
            Since the semiring is a strictly monotonic museurable semiring,  by \autoref{def:nwf:real_strongly_monotonic_semiring}~\eqref{ax:s2'} and Definition~\ref*{def:nwf:real_strongly_monotonic_semiring}~\eqref{ax:s5'}, it suffices to show that there is some $t_K : K \to T$ such that 
            \begin{align}
