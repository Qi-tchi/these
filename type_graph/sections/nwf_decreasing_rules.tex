...
\begin{example}
    ...
    Consider the DPO rule shown in~\autoref{fig:nwf:rewriting_step_tracsdfdsafdfsd}
     \begin{figure}[H] 
        \centering
      ...
      \caption{}
      \label{fig:nwf:rewriting_step_tracsdfdsafdfsd}
  \end{figure}
   and the weighted type graph in \autoref{nwf:example:weighted_type_graphd_grsaa_sdfsf} over the real arithmetic semiring $\mathfrak{N}' = (\mathbb{R}^+,+,*,0_\mathbb{R},1_\mathbb{R},<,\operatorname{id}_{\mathbb{R}^+})$ shown below
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
        ...
        \end{tikzpicture}
        \caption{}
        \label{nwf:example:weighted_type_graphd_grsaa_sdfsf}
    \end{figure}
     There are 4 morphisms $t_K^{11}, t_K^{12}, t_K^{21}, t_K^{22}$ from $K$ to $T$ shown in~\autoref{fig:nwf:example:decreasing_rule_morphisms_grsaa_sfsdjl}.
    ...
    \begin{figure}[H]
      ...
      \end{figure}
    The set $\{l \star - = t_K^{11}\}$ has two morphisms $h_{11}^1$ and $h_{11}^2$ shown in~\autoref{fig:nwf:dfsdfjejrhti3erjwm}.
    \begin{figure}[H]
        \centering
        \resizebox{0.6\textwidth}{!}{
        \begin{tikzpicture}
        ...
        \caption{}
        \label{fig:nwf:dfsdfjejrhti3erjwm}
      \end{figure}
    Therefore, we have \begin{flalign*}
        ...
        =&2.0
    \end{flalign*}
    The set $\{r \star - = t_K^{11}\}$ has one morphism $h_{11}^3$ as illustrated in~\autoref{fig:nwf:dfjsdkfjsalfjdsjhsdjkfhsa}.
    \begin{figure}[H]
        \centering
        ...
        \caption{}
        \label{fig:nwf:dfjsdkfjsalfjdsjhsdjkfhsa}
      \end{figure}
    ...
    Moreover, there exists a context closure $c$ for the DPO rule in the weighted type graph, by \autoref{wf:example:context_closure}, shown in~\autoref{fig:nwf:fjaklgja_dsjfals}.
    \begin{figure}[H]
        \centering
    \resizebox{0.6\textwidth}{!}{
    \begin{tikzpicture}
