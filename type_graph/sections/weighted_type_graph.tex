Throughout this chapter, let \(\mathcal{C}\) be a fixed locally small category. A weighted type graph is an object \(T\) in \(\mathcal{C}\) (the type graph), equipped with a distinguished family of morphisms into \(T\), each endowed with a weight.
