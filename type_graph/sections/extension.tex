...
\noindent It is visualized in Figure~\ref{fig:nwf:weighted_type_graph_sss}.
    \begin{figure}[H] 
        ...
        \begin{tikzpicture} 
            \graphbox{}{0mm}{0mm}{32mm}{24mm}{-9mm}{-12mm}{
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
          \graphbox{\( L \)}{-50mm}{0mm}{40mm}{35mm}{2mm}{-6mm}{
            ...
            \graphbox{$T$}{0mm}{0mm}{40mm}{35mm}{-10mm}{-18mm}{
            ...
            \node () at (-5mm,-12mm) {$\overset{h_{11}^1}{\to}$};
        \end{tikzpicture}
        }
...
\subsection{Approximating weights of pushout objects}
