    ...
    \begin{itemize}
        ...
        \begin{flalign*}
             0_S &= a \mathop{\odot} 0_S & \text{$0_S$ is annihilator for $\mathop{\odot}$}\\
                 ...
                 &\mathop{\prec} b \mathop{\odot} x \mathop{\odot} y &\text{by Axiom~\eqref{ax:s4} and $x,y\mathop{\neq} 0_S$}\\
        ...
        \begin{flalign*}
            ...
            & \mathop{\prec} \left(b \mathop{\odot} x \right)   \mathop{\oplus} \left( b \mathop{\odot} y \right)  & \text{by Axiom~\eqref{ax:s2}}\\
